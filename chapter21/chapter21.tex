...
%\end{marginfigure}%%%%%%% MARGIN FIGURE
%\begin{marginfigure}[0cm]%%%%%%%% MARGIN FIGURE
%\includegraphics[width=0.8\columnwidth]{./figure13}
...
%\includegraphics[width=0.8\columnwidth]{./figure14}
