...
%%% COLOR IN THE TITLE \section{\color{blue!30!black}{The nature of acids and Bases}}\import{../\chapterlabel/files/}{SubSection-The-nature-of-acids-and-Bases-Acids-and-bases}


\section{The nature of acids and Bases}\import{../\chapterlabel/files/}{SubSection-The-nature-of-acids-and-Bases-Acids-and-bases}
...
\section{Dissociation of acids and bases}\import{../\chapterlabel/files/}{SectionIntro-Dissociation-of-acids-and-bases}
\sloppy\begin{description}
...
\section{Strength of acids and bases}\import{../\chapterlabel/files/}{SectionIntro-Strength-of-acids-and-bases}
\sloppy\begin{description}
...
\section{The PH scale}\import{../\chapterlabel/files/}{SectionIntro-The-PH-scale}
\sloppy\begin{description}
...
\providetoggle{chem121}\settoggle{chem121}{\chemversionhealthalied}\iftoggle{chem121}{}{
%%%%%%%%%%%%%%%%%%%%%%NOT FOR 121
\section{PH of strong acid-base solutions}  
...
%%%%%%%%%%%%%%%%%%%%%%NOT FOR 121
\section{PH of weak acid-base solutions}\import{../\chapterlabel/files/}{SectionIntro-weak-acid-base-solutions}  
\sloppy\begin{description}
...
\item[\docfilehook{ PH of solutions of salt}{}] \import{../\chapterlabel/files/}{SubSection-The-PH-scale-PH-of-salt-solutions} 
...
\section{Math interlude: how to solve quadratic equations}  \import{../\chapterlabel/files/}{SectionIntro-quadratic}
\sloppy\begin{description}
\item[\docfilehook{Solve quadratic equations}{}]\import{../\chapterlabel/files/}{BOX-quadraticformulas-calculator} 
\end{description}
%%%%%%%%%%%%%%%%%%%%%%NOT FOR 121
}

\section{Buffer solutions}\import{../\chapterlabel/files/}{SectionIntro-Buffer-solutions}
\sloppy\begin{description}
...
\section{Titrations}\import{../\chapterlabel/files/}{SectionIntro-Titrations}
\sloppy\begin{description}
...
\section{Titrations curves}\import{../\chapterlabel/files/}{SectionIntro-Titration-curves} 
\sloppy\begin{description} 
...
%%%%%%%%%%%%%%%%%%%%%%NOT FOR 121
\import{../\chapterlabel/files/}{Table-Titration-formulas} 

\section{Quantitative analysis of a titration}\import{../\chapterlabel/files/}{SectionIntro-Quantitative-analysis-of-a-titration}
\sloppy\begin{description}
...
\section{Blood as a buffer}\import{../\chapterlabel/files/}{SectionIntro-Blood-as-a-buffer}
\sloppy\begin{description}
...
\end{description}
 ...
 \providetoggle{chem121}\settoggle{chem121}{\chemversionhealthalied}\iftoggle{chem121}{}{
 %%%%%%%%%%%%%%%%%%%%%%NOT FOR 121
\section{Molecular mechanisms behind acid-base strength}\import{../\chapterlabel/files/}{SectionIntro-Strength-of-acids-and-its-structure}
\sloppy\begin{description}
...
\item[\docfilehook{Molecular mechanisms behind acid-base strength: a review}{}] \import{../\chapterlabel/files/}{BOX-acid-mechanisms}
 \end{description}
%%%%%%%%%%%%%%%%%%%%%%NOT FOR 121

%%%%%%%%%%%%%%%%%%%%%%NOT FOR 121

\section{Indicators}\import{../\chapterlabel/files/}{SectionIntro-Indicators}
...
\begin{fullwidth}\begin{minipage}[b]{1.2\linewidth}\resizebox{0.8\textwidth}{!}{
\stepcounter{tablenewcounter}\refstepcounter{table}\label{tab:Table-Indicators}
\import{../\chapterlabel/files/}{Table-Indicators} 
...
%%%%%%%%%%%%%%%%%%%%%%NOT FOR 121
\section{Titrations of polyprotic acids}\import{../\chapterlabel/files/}{SectionIntro-Titrations-of-polyprotic-acids}
\sloppy\begin{description}
