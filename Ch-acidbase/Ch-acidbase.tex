...
%\includegraphics{../Ch-acidbase/figure7}
...
%\begin{marginfigure}%%%%%%%% MARGIN FIGURE
%\includegraphics{../Ch-acidbase/figure8}
%\caption{Ashes are basic. }
%\end{marginfigure}%%%%%%% MARGIN FIGURE

%\begin{marginfigure}%%%%%%%% MARGIN FIGURE
%\includegraphics{../Ch-acidbase/figure10}
...
\begin{center}
\begin{tabular*}{1\textwidth}{@{\extracolsep{\fill}}>{\centering}m{0.1\textwidth}>{\centering}m{0.05\textwidth}>{\centering}m{0.2\textwidth}>{\centering}m{0.1\textwidth}>{\centering}m{0.04\textwidth}>{\centering}m{0.04\textwidth}>{\centering}m{0.25\textwidth}}
\chemfig{H_2O}&
$+$&
...
% \textcolor{blue}{Acid} && \textcolor{red}{Base} && \textcolor{blue}{Conjugate Base} &&\textcolor{red}{Conjugate Acid}\tabularnewline
\end{tabular*}\end{center}
\flushright{  \small Answer: \ce{ B  +  A    -> CA   + CB}
}
\end{example}%%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX\end{description}
...
%\begin{marginfigure}%%%%%%%% MARGIN FIGURE
%\includegraphics{../Ch-acidbase/figure9}
...
%\includegraphics{../Ch-acidbase/figure11}
...
%\end{marginfigure}%%%%%%% MARGIN FIGURE
%\begin{marginfigure}[0cm]%%%%%%%% MARGIN FIGURE
%\includegraphics{../Ch-acidbase/figure12}
...
%\end{marginfigure}%%%%%%% MARGIN FIGURE
%\begin{marginfigure}[0cm]%%%%%%%% MARGIN FIGURE
%\includegraphics[width=0.8\columnwidth]{../Ch-acidbase/figure13}
...
%\includegraphics[width=0.8\columnwidth]{../Ch-acidbase/figure14}
...
\draw[dashed] (2.1,-1) -- (2.1,-3);
   \node[anchor=south west,inner sep=0] (image1) at (.1cm,-3cm) {\includegraphics[width=0.1\columnwidth]{../Ch-acidbase/figure6}};\node[font=\small, anchor=south west ]  at ([shift={(0.5cm,-0.5cm)}]image1.south west)  {lemon}; 
\draw[dashed] (5.25,-1.2) -- (5.25,-2);
   \node[anchor=south west,inner sep=0] (image2) at (4cm,-3cm) {\includegraphics[width=0.1\columnwidth]{../Ch-acidbase/figure3}};\node[font=\small, anchor=south west ]  at ([shift={(0.5cm,-0.5cm)}]image2.south west)  {Coffee}; 
\draw[dashed] (7.3,-1) -- (7.3,-3);
   \node[anchor=south west,inner sep=0] (image2) at (7.0cm,-3cm) {\includegraphics[width=0.05\columnwidth]{../Ch-acidbase/figure4}};\node[font=\small, anchor=south west ]  at ([shift={(-0.0cm,-0.5cm)}]image2.south west)  {water};
    
    \draw[dashed] (9.3,-1.2) -- (9.3,-3);
   \node[anchor=south west,inner sep=0] (image2) at (9.0cm,-3cm) {\includegraphics[width=0.05\columnwidth]{../Ch-acidbase/figure5}};\node[font=\small, anchor=south west ]  at ([shift={(-0.0cm,-0.5cm)}]image2.south west)  {egg-whites};
\draw[dashed] (12.5,-1.2) -- (12.5,-3);
   \node[anchor=south west,inner sep=0] (image2) at (12.5cm,-3cm) {\includegraphics[width=0.1\columnwidth]{../Ch-acidbase/figure2}};\node[font=\small, anchor=south west ]  at ([shift={(0.3cm,-0.5cm)}]image2.south west)  {chlorox};
\end{tikzpicture}
...
%\includegraphics{../Ch-acidbase/figure16}
...
%\includegraphics{../Ch-acidbase/figure15}
...
%\begin{marginfigure}[4cm]%%%%%%%% MARGIN FIGURE
%\includegraphics{../Ch-acidbase/figure17}
...
%\includegraphics{../Ch-acidbase/figure18}
...
%\begin{marginfigure}[5cm]%%%%%%%% MARGIN FIGURE
%\includegraphics{../Ch-acidbase/figure19}
