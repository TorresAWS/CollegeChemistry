...
\section{\color{blue!30!black}{Math interlude: how to solve quadratic equations}}    \import{../\chapterlabel/files/}{SectionIntro-quadratic}
\sloppy\begin{description}
...
\renewcommand\chapterpathtoimages{../../}
...
%\newpage
\begin{fullwidth}
\hspace{1cm} \begin{minipage}[b]{1.2\linewidth}
