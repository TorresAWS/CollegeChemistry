...
\stepcounter{figurenewcounter}   \refstepcounter{figure}  \label{Fig:{\chapterlabel}\thefigurenewcounter}
    ...
    \hspace{-2cm}\begin{minipage}[b]{1.5\linewidth}
     ...
     \begin{tikzpicture}\path (0.45,3.3) node {\includegraphics[width=0.75cm]{./water}}
      (1.6,4.4)  node {\includegraphics[width=0.75cm]{./water}}
      (0.5,4.45) node {\includegraphics[width=0.75cm]{./water}}
      (1.1,3.7)  node {\includegraphics[width=0.75cm]{./water}};
...
\foreach \x in {5,7,9} {
    \foreach \y in {1,3,5} {
        ...
        \node at (\x+0.45,\y+0.3)         {\includegraphics[width=0.75cm]{./water}};
       \node at (\x+1.6 ,\y+1.4) {\includegraphics[width=0.75cm]{./water}};
        \node at (\x+0.5 ,\y+1.45) {\includegraphics[width=0.75cm]{./water}};
        \node at (\x+1.1 ,\y+0.7) {\includegraphics[width=0.75cm]{./water}};
        % edge of each box
     }
}\end{scope}
\begin{scope}[shift={(4,0)}]
...
red,
solid
] file[skip first] {./data1.dat};
\addplot[
smooth,
thin,
blue,
solid
] file[skip first] {./data2.dat};
\addplot[
smooth,
thin,
green,
solid
] file[skip first] {./data3.dat};
