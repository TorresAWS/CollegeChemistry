...
%      \begin{marginfigure}
%      \begin{tikzpicture} \node (a) at (0,0) {\includegraphics[width=4cm]{../\chapterlabel/figure1}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]a.south east) {\textsuperscript{\textcopyright} PxFuel} ;
%\end{tikzpicture}
%\end{marginfigure}
...
\newpage \hspace{5cm}\import{../\chapterlabel/files/}{Table-Entropy-phase-change}	
...
\begin{marginfigure}[-8cm]\usetikzlibrary {shapes.symbols}\begin{tikzpicture}[every node/.style={signal, draw,  text=white, signal to=nowhere}]\node[fill=red!65!black, signal to=east] at (0,1) {ADVANCED!};\end{tikzpicture}\end{marginfigure}
...
\sloppy\begin{description}
\item[\docfilehook{3D graphs and contour plots}{ }] \import{../\chapterlabel/files/}{Subsection-Temperature-and-pressure-effects-on-a-reaction-2d}
\hspace{8cm} \begin{center}\import{./files/}{Figure-2dGLines}\end{center}
\item[\docfilehook{Standard and equilibrium pressure conditions}{ }] \import{../\chapterlabel/files/}{Subsection-pressure-conditions}
...
\item[\docfilehook{Why reaction happen spontaneously}{ }] \import{../\chapterlabel/files/}{Subsection-interpret3d}
...
\newpage
\hspace{6cm}\import{./files/}{Figure-2dG}
 \end{description}
...
\import{../\chapterlabel/thermodynamictables/}{Table-thermod-data}
