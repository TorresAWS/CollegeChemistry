...
\stepcounter{graphcounter}   
 ...
 \node[inner sep=0pt,rotate=-90]   at (0,0) {Graph {\thegraphcounter} time (X axis) vs. Temperature (Y axis). Replicate 1 };
 \end{scope}
\end{tikzpicture}
 \end{sidewaystable}
%\clearpage\mbox{}\clearpage
...
\stepcounter{graphcounter}   
  \begin{sidewaystable}[ph!]
 \begin{tikzpicture}[remember picture,overlay]
 \begin{scope}[shift={(0cm,10cm)},rotate=-90]
 \draw[step=1mm,help lines] (0,0) grid (190mm,190mm);
 \draw[step=10mm] (0,0) grid (190mm,190mm);
  \end{scope}
 \begin{scope}[shift={(20cm,-0cm)},rotate=0]
 \node[inner sep=0pt,rotate=90]   at (0,0) {Graph {\thegraphcounter} time (X axis) vs. Temperature (Y axis). Replicate 2 };
 \end{scope}
\end{tikzpicture}
 \end{sidewaystable}
