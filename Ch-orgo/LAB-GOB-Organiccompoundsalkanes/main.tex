...
\renewcommand\ChapterNameLabel{Ch-orgo}\renewcommand\labname{Organiccompoundsalkanes}\renewcommand\chapterpathtocontent{../../}\renewcommand\chapterpath{../LAB-GOB-\labname/}\subfile{./\labname.tex}
