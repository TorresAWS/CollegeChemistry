...
\begin{minipage}[b]{1.0\linewidth}\resizebox{.9\textwidth}{!}{
\import{../\chapterlabel/files/}{Figure-Enzymes}
}\end{minipage}
...
\begin{center}\begin{minipage}[b]{1\linewidth}\resizebox{1.0\textwidth}{!}{
\import{../\chapterlabel/files/}{Figure-vulcano-plots}
