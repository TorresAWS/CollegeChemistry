...
\section{Experimental measurement of reaction rates}\import{../\chapterlabel/files/}{SectionIntro-Measure-rates}
\sloppy\begin{description}
\item[\docfilehook{Concentration vs. time plots}{}] \import{../\chapterlabel/files/}{Section-Measure-rates-concentration-vs-time}
\begin{center}\import{../\chapterlabel/files/}{Figure-Initial-velocities}\end{center}
\item[\docfilehook{Initial velocities}{}] \import{../\chapterlabel/files/}{Section-Measure-rates-Initial-velocities}
...
\item[\docfilehook{The integral method: associating a linear plot with an order}{}] \import{../\chapterlabel/files/}{SectionIntro-Dif-and-integralSubsection-The-integral-method-associating-a-linear-plot-with-an-order}
  ...
  \import{../\chapterlabel/files/}{Figure-kinetics-ideas}

\item[\docfilehook{How to carry out a linear regresion with a calculator}{}] \import{../\chapterlabel/files/}{SectionIntro-Dif-and-integralSubsection-LR-with-calculator}

\item[\docfilehook{How to carry out a linear regresion using GraphPad }{}] \import{../\chapterlabel/files/}{SectionIntro-Dif-and-integralSubsection-LR-with-GraphPad}
...
\item[\docfilehook{Concentration of reactants}{}] \import{../\chapterlabel/files/}{Subsecion-Concentration-of-reactants}
 \vspace{3cm}  \import{../\chapterlabel/files/}{Figure-Collision-theory} \newpage
...
\item[\docfilehook{Apparent activation energy }{}] \import{../\chapterlabel/files/}{SectionIntro-Reaction-mechanismsSubsectionApparent-k}
...
\section{Catalysis by enzymes} \import{../\chapterlabel/files/}{SectionIntro-Catalysis-by-enzymes}
\sloppy \begin{description}
\item[\docfilehook{What are enzymes}{}]  \import{../\chapterlabel/files/}{Section-Catalysis-by-enzymesSubsection-What-are-enzymes}
\begin{minipage}[b]{1.0\linewidth}\resizebox{.9\textwidth}{!}{\import{../\chapterlabel/files/}{Figure-Enzymes}}\end{minipage}
\item[\docfilehook{Amylase}{}]  \import{../\chapterlabel/files/}{Section-Catalysis-by-enzymesSubsection-Amylase}  
\begin{fullwidth}\begin{center}\begin{minipage}[b]{1\linewidth}\resizebox{1.0\textwidth}{!}{\import{../\chapterlabel/files/}{Figure-Michaelis-menten-plot}}\end{minipage} \end{center}\end{fullwidth}
\item[\docfilehook{Michaelis-Menten equation}{}]  \import{../\chapterlabel/files/}{Section-Catalysis-by-enzymesSubsection-Michaelis-Menten-equation}
\item[\docfilehook{Lineweaver-Burk linear equation}{}]  \import{../\chapterlabel/files/}{Section-Catalysis-by-enzymesSubsection-Lineweaver-Burk-linear-equation}
\begin{center}\begin{minipage}[b]{1\linewidth}\resizebox{1.0\textwidth}{!}{\import{../\chapterlabel/files/}{Figure-vulcano-plots}}\end{minipage} \end{center}
\item[\docfilehook{Eadie-Hofstee linear equation}{}]  \import{../\chapterlabel/files/}{Section-Catalysis-by-enzymesSubsection-Eadie-linear-equation}
\import{../\chapterlabel/problems/}{SampleProblem17}

\item[\docfilehook{PH and temperature effects}{}]  \import{../\chapterlabel/files/}{Section-Catalysis-by-enzymesSubsection-PH-and-temperature-effects}

%  \import{../\chapterlabel/problems/}{SampleProblemXX}
  \end{description}
