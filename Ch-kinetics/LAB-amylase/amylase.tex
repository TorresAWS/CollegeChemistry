...
\newcommand\chapterlabel{../Ch-kinetics/LAB-clockreaction}
...
\import{\chapterlabel/}{experiment}
...
\node[inner sep=0pt,rotate=0]   at (0,0) {Graph {\thegraphcounter} M-M plot:  Initial rate (\mycircled{7} \: Y axis) vs. substrate concentration (\mycircled{1} \: X axis)  };
\end{scope}
\end{tikzpicture}
\end{center}
...
\stepcounter{graphcounter}   
 ...
 \draw[step=10mm] (0,0) grid (190mm,190mm);
  \end{scope}
 \begin{scope}[shift={(-5cm,-36cm)},rotate=0]
 \node[inner sep=0pt,rotate=0]   at (0,0) {Graph {\thegraphcounter} Column 14 inverse of initial rate (Y axis) vs. Column 13 inverse of substrate concentration (X axis)  };
 \end{scope}
\end{tikzpicture}
\end{center}
