...
%\begin{marginfigure}
%      \includegraphics{../{\chapterlabel}/\chapterlabel}
%   \end{marginfigure}
...
\section{The atom}\import{../\chapterlabel/files/}{SectionIntro-The-atom}
\sloppy\begin{description}
...
\newpage \checkoddpage\ifoddpage \hspace{10cm} \else  \fi
