...
\addcontentsline{toc}{chapter}{Atoms and elements}
...
%%%%%%%%%%%%%HEADING
\newgeometry{right=5cm}\thispagestyle{sidebar}\sidebar{   \vspace{1em}\vspace{1cm} \vfill \par\vspace*{2em}}\restoregeometry\clearpage \begin{multicols}{2}\begin{tcolorbox}[enhanced jigsaw,breakable,size=title,colback=mybrown!05,colframe=black,fonttitle=\bfseries,title=STUDENT INFO,pad at break=1mm, break at=20cm/0pt ]\vspace{0.2cm}\noindent Name:  \rule{4cm}{0.4pt}  \hspace{0.1cm}Date: \rule{1cm}{0.4pt}\\\end{tcolorbox}\end{multicols}\hfill\vspace{-3.2cm}\begin{center}{\large \bfseries \hspace{7cm}Results\\ \hspace{7cm}EXPERIMENT \par\Huge\hspace{7cm}
 \import{\chapterpath/}{title}
\\[5pt] \par}\vspace{0.2cm}\end{center}\par\noindent\uline{  \hfill \normalsize \hfill       }
%%%%%%%%%%%%%HEADING
