...
\usepackage{paracol}
\usepackage{chemfig}
\usetikzlibrary{3d,decorations.pathreplacing,calligraphy}
...
%\newcommand{\bondwidth}{0.06642 em} % 'Line Width'\setbondstyle{line width = \bondwidth}
...
\begin{solution}
\import{../\chapterlabel/problems/problems/}{#1.answer}
\hspace{0.1cm}
\end{solution}
\stepcounter{numA}
}
...
%%%\PrintAllProblemsFillable{Problems-Basic-algebra}
 ...
 \newcounter{NumberofProblemsFinal}
 \newcommand{\PrintAllProblemsFillable}[1]{ 
 \def\ProblemSectionlabel{#1}
 \CatchFileDef\NumberofProblemstxt{../\chapterlabel/problems/problems/\ProblemSectionlabel.numberofquestions}{\endlinechar=-1 } 
 \setcounter{NumberofProblemsFinal}{\NumberofProblemstxt}
 \foreach \n in {1,...,\theNumberofProblemsFinal}{
 \setcounter{ntostring}{\n}
 \addproblemWithAnswerBox{\ProblemSectionlabel.\thentostring.A}     
 \addproblemWithAnswerBox{\ProblemSectionlabel.\thentostring.B}     
}
}
%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %%% MACRO FOR RENDERING A SINGLE RABDOM PROBLEMS OF A PROBLEM SECTION
%THIS MACRO PRINTS one random problem from the file #1 e.g. Problems-Basic-algebra either replica A or B as indicated in %2
%%% e.g. \PrintOneProblemFillableRANDOM{Problems-Basic-algebra}{A}
\newsavebox\myhiddenbox
  \usepackage[]{lcg}
\newcommand{\thecmd}[2]{\chgrand[first=#1]\reinitrand[last=#2]\sbox{\myhiddenbox}{\rand\arabic{rand}}}
 \newcommand{\PrintOneProblemFillableRANDOM}[2]{ 
 \renewcommand\ProblemSectionlabel{#1} 
 \CatchFileDef\NumberofProblemstxt{../\chapterlabel/problems/problems/\ProblemSectionlabel.numberofquestions}{\endlinechar=-1 }
 \setcounter{NumberofProblemsFinal}{\NumberofProblemstxt}
 \thecmd{1}{\theNumberofProblemsFinal}
 \addproblemWithAnswerBox{\ProblemSectionlabel.\therand.#2}     
 }
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%THRE MACROS
%\addproblemWithAnswerBox{Problems-Basic-algebra.1.A} Print a problems with answer box
%\PrintAllProblemsFillable{Problems-Scientific-Notation} Print all problems of a section with answer box
%\PrintOneProblemFillableRANDOM{Problems-Scientific-Notation}{A} Print one random problem of type A as indiecated of a section with answer box
...
\newcommand\chemversionhealthalied{false}%%TRUE for chem 121 version FALSE for 201-2
 \newcommand\showfinalanswers{false}%%TRUEfor showing answers false for not
  \newcommand\ShowUneditedText{true}%%TRUEfor showing unedited text
 ...
 \begin{document} 
\subfile{../Ch-main/cover/title.tex}
\subfile{../Ch-main/periodictable/periodictable.tex}
\clearpage\thispagestyle{empty}\mbox{}\clearpage
\tableofcontents
 \clearpage\thispagestyle{empty}\mbox{}
 \clearpage\thispagestyle{empty}\mbox{}
\subfile{../Ch-main/tothereader/tothereader.tex}
\clearpage\thispagestyle{empty}\mbox{}
\subfile{../Ch-main/online/online.tex}\clearpage\thispagestyle{empty}\mbox{}\clearpage
%\subfile{../Ch-main/calendar/calendar.tex}


\subfile{../Ch-parts/a.tex} 
\clearpage\thispagestyle{empty}\mbox{}

\subfile{../Ch-measurements/Ch-measurements.tex}
\subfile{../Ch-measurements/Ch-measurementsProblems.tex}
%%\subfile{./review/1.tex}
\subfile{../Ch-Table/Ch-Table.tex}
\subfile{../Ch-Table/Ch-TableProblems.tex}
%%%\subfile{./review/1-2.tex}
 \clearpage\thispagestyle{empty}\mbox{}

\subfile{../Ch-parts/b.tex}
 \clearpage\thispagestyle{empty}\mbox{}

\subfile{../Ch-naming/Ch-naming.tex} 
\subfile{../Ch-naming/Ch-namingProblems.tex} 
\subfile{../Ch-mole/Ch-mole.tex}
\subfile{../Ch-mole/Ch-moleProblems.tex}
%%%\subfile{./review/3-4.tex}

\subfile{../Ch-parts/c.tex}
\subfile{../Ch-electrolytes/Ch-electrolytes.tex}
\subfile{../Ch-electrolytes/Ch-electrolytesProblems.tex}
\subfile{../Ch-Gas/Ch-Gas.tex}
\subfile{../Ch-Gas/Ch-GasProblems.tex}
%%\subfile{./review/5-6.tex}

 \clearpage\thispagestyle{empty}\mbox{}\subfile{../Ch-parts/d.tex} \clearpage\thispagestyle{empty}\mbox{}

\subfile{../Ch-thermochemistry/Ch-thermochemistry.tex}
\subfile{../Ch-thermochemistry/Ch-thermochemistryProblems.tex}
\subfile{../Ch-radiation/Ch-radiation.tex}
\subfile{../Ch-radiation/Ch-radiationProblems.tex}
%%\subfile{./review/7-8.tex}

\subfile{../Ch-parts/e.tex}
\subfile{../Ch-electronicstructure/Ch-electronicstructure.tex}
\subfile{../Ch-electronicstructure/Ch-electronicstructureProblems.tex}
\subfile{../Ch-solids/Ch-solids.tex} 
\subfile{../Ch-solids/Ch-solidsProblems.tex}
...
%\subfile{./review/1-10.tex}
 ...
 \clearpage\thispagestyle{empty}\mbox{}\subfile{../Ch-parts/f.tex} \clearpage\thispagestyle{empty}\mbox{}
\subfile{../Ch-orgo/Ch-orgo.tex}
\subfile{../Ch-orgo/Ch-orgoProblems.tex}
\subfile{../Ch-solutions/Ch-solutions.tex}
\subfile{../Ch-solutions/Ch-solutionsProblems.tex}

 \clearpage\thispagestyle{empty}\mbox{}\subfile{../Ch-parts/g.tex} \clearpage\thispagestyle{empty}\mbox{}
\subfile{../Ch-kinetics/Ch-kinetics.tex}
\subfile{../Ch-kinetics/Ch-kineticsProblems.tex}
\subfile{../Ch-equilibrium/Ch-equilibrium.tex}
\subfile{../Ch-equilibrium/Ch-equilibriumProblems.tex}

 \clearpage\thispagestyle{empty}\mbox{}\subfile{../Ch-parts/h.tex} \clearpage\thispagestyle{empty}\mbox{}
\subfile{../Ch-acidbase/Ch-acidbase.tex}
\subfile{../Ch-acidbase/Ch-acidbaseProblems.tex}
\subfile{../Ch-solubility/Ch-solubility.tex}
\subfile{../Ch-solubility/Ch-solubilityProblems.tex}

 \clearpage\thispagestyle{empty}\mbox{}\subfile{../Ch-parts/i.tex} \clearpage\thispagestyle{empty}\mbox{}
\subfile{../Ch-thermo/Ch-thermo.tex}
\subfile{../Ch-thermo/Ch-thermoProblems.tex}
\subfile{../Ch-electrochem/Ch-electrochem.tex}
\subfile{../Ch-electrochem/Ch-electrochemProblems.tex}
   
\subfile{../Ch-parts/j.tex}
\subfile{../Ch-nuclear/Ch-nuclear.tex}
\subfile{../Ch-nuclear/Ch-nuclearProblems.tex}

\subfile{../Ch-biochemistry/Ch-biochemistry.tex}
\subfile{../Ch-biochemistry/Ch-biochemistryProblems.tex}



%%%%%%%%%%%%%%%FOR 121%%%%%%%%%%%%%%%%%%%%%%%%
%\newcommand{\ProblemName}{Problems.tex}
% \foreach \nchapter in {Ch-measurements,Ch-thermochemistry,Ch-Table,Ch-nuclear,Ch-naming,Ch-mole,Ch-Gas,Ch-electrolytes,Ch-equilibrium,Ch-acidbase,Ch-orgo}{
%\subfile{../\nchapter/\nchapter.tex}
%\subfile{../\nchapter/\nchapter\ProblemName}
%}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subfile{../Ch-main/cover/back.tex}
