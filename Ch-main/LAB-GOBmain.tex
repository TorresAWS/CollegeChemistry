...
\newcommand\chemversionhealthalied{true}%%TRUE for chem 121 version FALSE for 201-2
...
\newcommand\titlenew{} \definecolor{blueXIIdark}{cmyk}{1,.8,.30,.05}\providetoggle{chem121}\settoggle{chem121}{\chemversionhealthalied}\iftoggle{chem121}{\renewcommand\titlenew{\fontsize{40}{50}\selectfont \color{blueXIIdark} GOB Chemistry Experiments}       }{ \renewcommand\titlenew{{\fontsize{50}{60}\selectfont \color{blueXIIdark} College Chemistry Experiments}}}

 
% \renewcommand\titlenew{Experiments}
...
\subfile{../Ch-main/tothereader/tothereaderExperiment.tex}
 \clearpage\thispagestyle{empty}\mbox{}\clearpage
...
\renewcommand\chapterlabel{Ch-measurements}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Chemistryandmeasurements}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}
 
 \renewcommand\chapterlabel{Ch-measurements}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Conversionfactorsandproblemsolving}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}
     
 \renewcommand\chapterlabel{Ch-measurements}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Densityandspecificgravity}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}

 \renewcommand\chapterlabel{Ch-thermochemistry}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Energyandmatter}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}
 \renewcommand\chapterlabel{Ch-Table}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Atomsandelements}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}

 \renewcommand\chapterlabel{Ch-thermochemistry}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Specificheatandfood}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}

 \renewcommand\chapterlabel{Ch-nuclear}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Nuclearchemistry}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}


 \renewcommand\chapterlabel{Ch-electronicstructure}\clearpage\mbox{}
 \clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Compoundsandtheirstructure}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}


 \renewcommand\chapterlabel{Ch-mole}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Chemicalreactionsandequations}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}
 
 \renewcommand\chapterlabel{Ch-mole}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Molesandchemicalformulas}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}


 \renewcommand\chapterlabel{Ch-Gas}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Gaslaws}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}
 
\renewcommand\chapterlabel{Ch-electrolytes}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Solutionselectrolytesconcentration}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}

 \renewcommand\chapterlabel{Ch-electrolytes}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Solubleandinsolublesalts}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}

 \renewcommand\chapterlabel{Ch-equilibrium}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Reactionrateschemicalequilibrium}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}

 \renewcommand\chapterlabel{Ch-acidbase}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Acidbasetitration}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}
