...
\newpage\section{ Chemistry and measurements   }\clearpage\mbox{}\clearpage \subfile{../Ch-measurements/LAB-GOB-Chemistryandmeasurements/Chemistryandmeasurements.tex}
 \newpage\section{ Conversion factors and problem solving   }\clearpage\mbox{}\clearpage \subfile{../Ch-measurements/LAB-GOB-Conversionfactorsandproblemsolving/Conversionfactorsandproblemsolving.tex}
\newpage \section{  Density and specific gravity  }\clearpage\mbox{}\clearpage \subfile{../Ch-measurements/LAB-GOB-Densityandspecificgravity/Densityandspecificgravity.tex}
 \newpage\section{ Energy and matter   }\clearpage\mbox{}\clearpage \subfile{../Ch-thermochemistry/LAB-GOB-Energyandmatter/Energyandmatter.tex}
  \newpage\section{  Atoms and elements  }\clearpage\mbox{}\clearpage \subfile{../Ch-Table/LAB-GOB-Atomsandelements/Atomsandelements.tex}
 \newpage\section{  Specific heat and food  }\clearpage\mbox{}\clearpage \subfile{../Ch-thermochemistry/LAB-GOB-Specificheatandfood/Specificheatandfood.tex}
 \newpage\section{  Nuclear chemistry  }\clearpage\mbox{}\clearpage \subfile{../Ch-nuclear/LAB-GOB-Nuclearchemistry/Nuclearchemistry.tex}
 \newpage\section{  Compounds and their structure  }\clearpage\mbox{}\clearpage \subfile{../Ch-electronicstructure/LAB-GOB-Compoundsandtheirstructure/Compoundsandtheirstructure.tex}
   \newpage\section{  Chemical reactions and equations  }\clearpage\mbox{}\clearpage \subfile{../Ch-mole/LAB-GOB-Chemicalreactionsandequations/Chemicalreactionsandequations.tex}

   \newpage\section{ Moles and chemical formulas   }\clearpage\mbox{}\clearpage \subfile{../Ch-mole/LAB-GOB-Molesandchemicalformulas/Molesandchemicalformulas.tex}
   \newpage\section{  Gas laws  }\clearpage\mbox{}\clearpage \subfile{../Ch-Gas/LAB-GOB-Gaslaws/Gaslaws.tex}


 \newpage\section{  Solutions, electrolytes, concentration   }\clearpage\mbox{}\clearpage \subfile{../Ch-electrolytes/LAB-GOB-Solutionselectrolytesconcentration/Solutionselectrolytesconcentration.tex}

 \newpage\section{  Soluble and insoluble salts  }\clearpage\mbox{}\clearpage \subfile{../Ch-electrolytes/LAB-GOB-Solubleandinsolublesalts/Solubleandinsolublesalts.tex}
  \newpage\section{  Reaction rates \&  chemical equilibrium   }\clearpage\mbox{}\clearpage \subfile{../Ch-equilibrium/LAB-GOB-Reactionrateschemicalequilibrium/Reactionrateschemicalequilibrium.tex}
  \newpage\section{  Acid-base titration   }\clearpage\mbox{}\clearpage \subfile{../Ch-acidbase/LAB-GOB-Acidbasetitration/Acidbasetitration.tex}
  \newpage\section{  Organic compounds: alkanes   }\clearpage\mbox{}\clearpage \subfile{../Ch-orgo/LAB-GOB-Organiccompoundsalkanes/Organiccompoundsalkanes.tex}
  \newpage\section{  Biological molecules: carbohydrates  }\clearpage\mbox{}\clearpage \subfile{../Ch-biochemistry/LAB-GOB-Biologicalmoleculescarbohydrates/Biologicalmoleculescarbohydrates.tex}
