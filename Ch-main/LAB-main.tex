...
%\clearpage\mbox{}\clearpage
 \newpage\section{Isomers }\subfile{isomers/isomers.tex }
 \newpage  \section{Conductivity of electrolyte solutions }\subfile{conductivity/conductivity.tex }
 \newpage  \section{Hard water }\subfile{hardwater/hardwater.tex }
  \newpage  \section{Freezing point depression }\subfile{freezingpointdepression/freezingpointdepression.tex }
  \newpage  \section{The iodine clock }\subfile{clockreaction/clockreaction.tex }
 \newpage  \section{Le Ch\^atelier's Principle}\subfile{lechatelier/lechatelier.tex }
 \newpage  \section{Equilibrium constant}\subfile{equilibriumconstant/equilibriumconstant.tex }

\newpage  \section{Titration curve}\subfile{titration-curve/titration-curve.tex }

  \newpage  \section{Bleach Strength}\subfile{bleach/bleach.tex }
 \newpage\section{Relative strength of some acids}\subfile{relativestrenthofacids/relativestrenthofacids.tex}
  \newpage \section{Entropy}\subfile{entropy/entropy.tex }
   \newpage  \section{A Solubility Product Constant: Solubility product calculation}\subfile{solubilityproduct/solubilityproduct.tex }
   \clearpage\mbox{}\clearpage \section{Electrochemistry: galvanic cells}\subfile{electrochem/electrochem.tex }
