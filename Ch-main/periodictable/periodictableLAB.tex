...
\begin{document}
 \newgeometry{a4paper,left=0.8in,right=0.5in,top=0.1in,bottom=0.5in,nohead}

%\begin{fullwidth}
%\begin{sidewaysfigure}
%\centering
\vspace{1.5cm}\hspace{2.5cm}
 
 
 
 
\begin{tikzpicture}[font=\sffamily, scale=0.50, transform shape, rotate=90, baseline={(0,9cm)}, yshift=-8cm, xshift=-32cm, remember picture,overlay]
...
%    {\SyntheticElementTextFormat{}{}{man-made}{}} ;
  \node[yshift=10cm] at ($(Mn.north -| Fe.west) + (5em,-15em)$) [name=elementLegend, Element, fill=white]
    {\NewNaturalElementTextFormat{Z}{mass}{Symbol}{Name}};

%% Diagram Title
  \node[yshift=2cm] at (H.west -| Fe.north) [name=diagramTitle, TitleLabel,text=blue, font=\sffamily]
    {\Huge Periodic Table of Chemical Elements};
  \node[yshift=1cm] at (H.west -| Fe.north) [name=diagramTitle, TitleLabel]
    {\small };
