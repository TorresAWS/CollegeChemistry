...
Hybrid classes in chemistry meet during the lab session. If you access CUNY first you will find the class meeting days anb times next to the class information. For example, it would say Chem 202 Wednesday 5-7.45PM. That means the class meets every week, assuming BMCC is open, on wednesdays at 5pm sharp. You also need to consult BMCC's calendar at https://www.bmcc.cuny.edu/academics/academic-calendar/ to find out what dates the school is open. Your instructior will never tell you if there is class next week, of even the present week as he or she, same as you, needs to consult CUNY first and BMCC's calendars. As instructors may have several sections in order not to give misleading information, it is recomended ti suggest students to check themself the calendars.

------------------------------------------------

\questionA{Do we have videos in an hybrid chem class?}\label{labels}

The answer is no, there is no prerecorded videos in your chem class. During the meeting sessions your instructor will have time to lecture on selected subjects, and those lectures are neither recorded not can be recorded due to privacy issues. If you want a class in which the instructor lectures through videos you may want to contact the instructir in hand to make sure that is the preferred methof of teaching.

------------------------------------------------

\questionA{How do I change the title and subtitle?}\label{change-title}
...
\questionA{Is it possible to change the spacing between the questions in the list of questions?}\label{change-spacing}
...
\questionA{What if I want to hide the page numbers and/or trailing dots next to the question in the list of questions?}\label{page-numbering}
...
\questionA{Is it possible to number questions?}\label{number-questions}
...
For example, this is question \thequestionsA. You can even incorporate question numbers into the questions and list of questions automatically by adding:
...
\questionA{Question \thequestionsA: Can I change the color of the question boxes?}\label{question-color}
