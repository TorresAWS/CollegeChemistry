...
The answer is no, there are no prerecorded videos in your chem class. During the meeting sessions, your instructor will have time to lecture on selected subjects, and those lectures are neither recorded nor can be recorded due to privacy issues. If you want a class in which the instructor lectures through videos you may wish to contact the instructor in hand to make sure that is the preferred method of teaching.
