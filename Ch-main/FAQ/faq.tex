...
You may bring a cheat sheet on 8.5x11 paper to the exam, written on both sides. No more than a single sheet will be allowed under any circumstance. In that sheet, which can contain a periodic table, you can write anything you want. You can also bring a calculator.
