...
\tikzset{
 ...
 \newcommand{\bondwidth}{0.06642 em}\setbondstyle{line width = \bondwidth}
...
\begin{tabular}{m{15em}| C{15em}| R{15em}|}
CHE 202	& Syllabus & {\semester} \the\year{}
\end{tabular}
		                 					 
\begin{center}BOROUGH OF MANHATTAN COMMUNITY COLLEGE\\
The City University of New York\\
Department of Science\end{center}
\begin{bf}Title of Course:\end{bf} College Chemistry II 	\\	
\begin{bf}Class Hours:\end{bf} 4\\
\begin{bf}Course Code:\end{bf} CHE 202  \\
\begin{bf}Laboratory Hours per Week:\end{bf} 3\\
\begin{bf}Semester:\end{bf} {\semester} \the\year{} \\
\begin{bf}Instructor Information (Phone\#, Office\#, email):\end{bf} Daniel Torres Rangel; N699E; dtorresrangel$@$bmcc.cuny.edu \\
\begin{bf}Credits:\end{bf} 4\\
\begin{bf}Course Description:\end{bf} This is a two-semester course sequence that involves the study of chemical principles including atomic and molecular theories, molecular structure, and reactivity. The laboratory will include experiments illustrating the chemical principles. 
CHE 201-202 two terms required.  Required in A.S. (Science), A.S. (Engineering Science), A.S. (Science for Forensics), and A.S. (Biotechnology Science).   Fulfills science requirement for A.A. (Liberal Arts)
Prerequisite for CHE 202 is CHE 201.\\
\begin{bf}Basic Skills:\end{bf} ACR 094, ENG 088 or ESL 054, and MAT 056 \\
\begin{bf}Prerequisites:\end{bf} CHE 201 \\
\begin{bf}Corequisites:\end{bf} \\

\begin{center}
\begin{tabularx}{\linewidth}{ | X | X |}
  \hline
   \bf{Course Student Learning Outcomes (Students will be able to?)	}&  \bf{Measurements (means of assessment for student learning outcomes listed in first column)} \\
    \hline
  1.	Identify and define key terminology in chemistry.	& 1. Examinations will measure students? ability to define terms in stoichiometric calculations\\
2. Explain chemical properties	& 2. Examinations will measure students? ability to explain atomic spectra from energy levels\\
3. Apply chemical concepts to chemical properties.	& 3. Examinations will measure students? ability to apply chemical bonding to properties of solids.\\
4. Compare chemical properties based on chemical models.	& 4. Examinations will measure student?s ability to compare types of chemical reactions\\
5. Categorize chemical properties based atomic and molecular structure.	& 5. Examinations will measure student?s ability to categorize periodicity of atomic properties.\\
6. Evaluate the effect of  changes in variables on chemical properties.	& 6. Examinations will measure student?s ability to evaluate enthalpy calculations.\\
  \hline
\end{tabularx}
\end{center}
	
	
	\begin{bf}Below are the college's general education learning outcomes, the outcomes that are checked in the left-hand column indicate goals that will be covered and assessed in this course.  (Check at least one.)\end{bf}
	
	\begin{center}
\begin{tabularx}{\linewidth}{ | X | X |}
  \hline
	\begin{bf}General Education Learning Outcomes\end{bf}	& \begin{bf}Measurements (means of assessment for general education goals listed in first column)\end{bf} \\  \hline
  \CheckedBox\hspace{1cm}Communication Skills- Students will be able to write, read, listen and speak critically and effectively.	& \\  \hline
 \CheckedBox\hspace{1cm}	  Quantitative Reasoning- Students will be able to use quantitative skills and the concepts and methods of mathematics to solve problems.	& Examinations will assess student?s ability to mathematical analyze quantitative problems in chemistry.\\  \hline
 \CheckedBox\hspace{1cm}	  Scientific Reasoning- Students will be able to apply the concepts and methods of the natural sciences.	& Examinations will assess student?s ability to interpret chemical properties based on chemical concepts and models.\\  \hline
\makebox[0pt][l]{$\square$}{\raisebox{0.1\height}{ }}\hspace{1cm} Social and Behavioral Sciences- Students will be able to apply the concepts and methods of the social sciences.	& \\  \hline
\makebox[0pt][l]{$\square$}{\raisebox{0.1\height}{ }}\hspace{1cm}Arts \& Humanities- Students will be able to develop knowledge and understanding of the arts and literature through critiques of works of art, music, theatre or literature. &	\\  \hline
Information \& Technology Literacy- Students will be able to collect, evaluate and interpret information and effectively use information technologies.	& \\  \hline
\makebox[0pt][l]{$\square$}{\raisebox{0.1\height}{ }}\hspace{1cm} Values- Students will be able to make informed choices based on an understanding of personal values, human diversity, multicultural awareness and social responsibility.	& \\  \hline
\end{tabularx}
\end{center}
\begin{bf}Required Text:\end{bf} 
Flowers, P., Theopold, K., Langley, R., \& Robinson, W. R. (2015). Chemistry: OpenStax. Available for free at https://openstax.org/details/books/chemistry-2e\\
%\begin{bf}Required Laboratory Manual:\end{bf}
%Wentworth, R. A. D., and Munk, Barbara H., Experiments in General Chemistry 11th Edition, Cengage Learning (2017), Boston MA.   ISBN 978-1-305-94498-5\\
\begin{bf}Required Laboratory Goggles \end{bf}
Appropriate chemical-resistant protective eyewear (goggles) must be purchased for use in the laboratory. The bookstore is carrying them (\$7.00).\\
\begin{bf}Other Resources\end{bf} 
\begin{bf}Use of Technology (If Applicable)\end{bf} \\
\import{./}{rubric}
\begin{bf}Class Participation\end{bf}\\
...
\begin{bf}BMCC Policy on Plagiarism and Academic Integrity Statement\end{bf}\\
...
\begin{bf}Gender-Inclusivity\end{bf}\\
...
\begin{bf}FREE BMCC STUDENT SUPPORT SERVICES\end{bf}\\
...
Ch 1 Organic and Biological Molecules
\begin{inparaenum}[(a)]
\item Alkanes: Saturated Hydrocarbons
\item  Alkenes and Alkynes
\item Aromatic Hydrocarbons
\item  Hydrocarbon Derivatives
\item  Natural Polymers
\end{inparaenum}

 Ch 2 Properties of Solutions:\begin{inparaenum}[(a)]
\item Solution Composition  
\item Energies of Solution Formation
\item Factors Affecting Solubility
\item Vapor Pressure of Solutions
\item Boiling Point Elevation and Freezing Point Depression
\item Osmotic Pressure
\item Colligative Properties of Electrolyte Solutions
\end{inparaenum}

Ch 3 Chemical Kinetics:\begin{inparaenum}[(a)]
\item Reaction Rates
\item Rate Laws
\item Determining the Form of the Rate Law
\item Integrated Rate Laws
\item Reaction Mechanisms
\item A Model for Chemical Kinetics
\item Catalysis
\end{inparaenum}

Ch 4 Chemical Equilibrium:\begin{inparaenum}[(a)]
\item The Equilibrium Condition
\item The Equilibrium Constant
\item Equilibrium Expressions Involving Pressures
\item Heterogeneous Equilibria
\item Applications of the Equilibrium Constant
\item Solving Equilibrium Problems
\item Le Chatelier's Princple
\end{inparaenum}

Ch 5 Acids and Bases:\begin{inparaenum}[(a)]
\item The Nature of Acids and Bases
\item Acid Strength
\item The pH Scale
\item Calculating the pH of Strong Acid Solutions
\item Calculating the pH of Weak Acid Solutions
\item Bases
\item Polyprotic Acids
\item Acid-Base Properties of Salts
\item The Effect of Structure on Acid-Base Properties
\item Acid-Base Properties of Oxides
\item The Lewis Acid-Base Model
\item Solutions of Acids or Bases Containing a Common Ion
\item Buffered Solutions
\item Buffering Capacity
\item Titrations and pH Curves
\item Acid-Base Indicators
\item Polyprotic Acid Titrations
\end{inparaenum}

Ch 6 Solubility and Complex Ion Equilibria:\begin{inparaenum}[(a)]
\item Solubility Equilibria and the Solubility Product
\item Precipitation 
\item Precipitation Conditions
\item Equilibria Involving Complex Ions
\end{inparaenum}

Ch 7 Spontaneity, Entropy and Free Energy:\begin{inparaenum}[(a)]
\item Spontaneous Processes and Entropy
\item Entropy and the Second Law of Thermodynamics
\item The Effect of Temperature on Spontaneity
\item Entropy Changes in Aqueous Solutions
\item Entropy Changes in Chemical Reactions
\item Free Energy
\item Free Energy and Chemical Reactions
\item The Dependence of Free Energy on Pressure
\item Free Energy and Equilibrium
\item Free Energy and Work
\end{inparaenum}

Ch 8 Electrochemistry:\begin{inparaenum}[(a)]
\item Galvanic Cells
\item Standard Reduction Potentials
\item Cell Potential, Electrical Work, and Free Energy
\item Dependence of Cell Potential on Concentration
\item Corrosion
\item Electrolysis
\end{inparaenum}
...
% 
%
% \renewcommand\chapterlabel{Ch-orgo}\clearpage\mbox{}\clearpage\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{Organiccompoundsalkanes}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpath{../\chapterlabel/LAB-GOB-\labname/}\subfile{\chapterpath/\labname.tex}
