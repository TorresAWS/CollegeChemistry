...
\renewcommand\labname{../\texbooklabel/LAB-clockreaction}\renewcommand\texbooklabel{Ch-kinetics}\renewcommand\pathtofiles{../\texbooklabel/}
\section{The iodine clock}\subfile{../\texbooklabel/Lab-clockreaction/clockreaction.tex }
\newpage  \section{Le Ch\^atelier's Principle}\subfile{../Ch-equilibrium/LAB-lechatelier/lechatelier.tex }
\newpage  \section{Equilibrium constant}\subfile{../Ch-equilibrium/LAB-equilibriumconstant/equilibriumconstant.tex }
\newpage  \section{Titration curve}\subfile{../Ch-acidbase/LAB-titration-curve/titration-curve.tex }

\newpage  \section{Bleach Strength}\subfile{../Ch-acidbase/LAB-bleach/bleach.tex }
\newpage\section{Relative strength of some acids}\subfile{../Ch-acidbase/LAB-relativestrenthofacids/relativestrenthofacids.tex}
...
\clearpage\mbox{}\clearpage \section{Electrochemistry: galvanic cells}\subfile{../Ch-electrochem/LAB-electrochem/electrochem.tex }

\renewcommand\labname{../\texbooklabel/LAB-nuclear}\renewcommand\texbooklabel{Ch-nuclear}\renewcommand\pathtofiles{../\texbooklabel/}
\section{Radioactivity: half-life of K-40}\subfile{../\texbooklabel/Lab-nuclear/Lab-nuclear.tex }
