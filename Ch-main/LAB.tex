...
\renewcommand\labname{../\texbooklabel/LAB-freezingpointdepression}\renewcommand\texbooklabel{Ch-solutions}\renewcommand\pathtofiles{../\texbooklabel/}\section{Freezing point depression}\subfile{../\texbooklabel/Lab-freezingpointdepression/LAB-freezingpointdepression.tex }
...
\renewcommand\labname{../\texbooklabel/LAB-lechatelier}\renewcommand\texbooklabel{Ch-equilibrium}\renewcommand\pathtofiles{../\texbooklabel/}\section{Le Ch\^atelier's Principle}\subfile{../\texbooklabel/Lab-lechatelier/LAB-lechatelier.tex }
\newpage \renewcommand\labname{../\texbooklabel/LAB-equilibriumconstant}\renewcommand\texbooklabel{Ch-equilibrium}\renewcommand\pathtofiles{../\texbooklabel/}\section{Equilibrium constant}\subfile{../\texbooklabel/Lab-equilibriumconstant/LAB-equilibriumconstant.tex }
\newpage \renewcommand\labname{../\texbooklabel/LAB-titration-curve}\renewcommand\texbooklabel{Ch-acidbase}
\renewcommand\pathtofiles{../\texbooklabel/}\section{Titration curve}\subfile{../\texbooklabel/Lab-titration-curve/LAB-titration-curve.tex }
\newpage  \renewcommand\pathtofiles{../\texbooklabel/}\section{Bleach Strength}\subfile{../\texbooklabel/Lab-bleach/LAB-bleach.tex }
\newpage  \renewcommand\pathtofiles{../\texbooklabel/}\section{Relative strength of some acids}\subfile{../\texbooklabel/Lab-relativestrenthofacids/LAB-relativestrenthofacids.tex }
...
\newpage 
\renewcommand\labname{../\texbooklabel/LAB-entropy}\renewcommand\texbooklabel{Ch-thermo}\renewcommand\pathtofiles{../\texbooklabel/}\section{Entropy and spontaneity}\subfile{../\texbooklabel/Lab-entropy/LAB-entropy.tex }

\newpage 
\renewcommand\labname{../\texbooklabel/LAB-solubilityproduct}\renewcommand\texbooklabel{Ch-tsolubility}\renewcommand\pathtofiles{../\texbooklabel/}\section{A Solubility Product Constant: Solubility product calculation}\subfile{../\texbooklabel/Lab-solubilityproduct/LAB-solubilityproduct.tex }
...
\renewcommand\labname{../\texbooklabel/LAB-electrochem}\renewcommand\texbooklabel{Ch-electrochem}\renewcommand\pathtofiles{../\texbooklabel/}\section{Electrochemistry: galvanic cells}\subfile{../\texbooklabel/Lab-electrochem/Lab-electrochem.tex }
\renewcommand\labname{../\texbooklabel/LAB-nuclear}\renewcommand\texbooklabel{Ch-nuclear}\renewcommand\pathtofiles{../\texbooklabel/}\section{Radioactivity: half-life of K-40}\subfile{../\texbooklabel/Lab-nuclear/Lab-nuclear.tex }
