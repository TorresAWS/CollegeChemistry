...
\newcommand{\Fractal}{\pgfdeclarelindenmayersystem{Koch curve}{
  \rule{F -> F-F++F-F}}
...
\pgfdeclarelindenmayersystem{Hilbert curve}{
 ...
 \begin{minipage}[b]{0.5\linewidth}\begin{center}
 \begin{adjustbox}{center, width=0.5\linewidth}   
\begin{tikzpicture}
\shadedraw[shading=color wheel] 
[l-system={Koch curve, step=2pt, angle=60, axiom=F++F++F, order=5}]
...
{\color{Magenta}Version 3.0 - {\today}} \\ % for 202
...
\vfill % Whitespace between the title and the author name
 ...
 \vfill 
{\Large\textbf{The Open Education Initiative}}\\ % Author name
...
\vspace{5cm}
\thispagestyle{empty}\startcontents[chapters]%
...
\printcontents[chapters]{l}{1}{\colorbox{ptctitle}{%
  \parbox[t]{\dimexpr\textwidth-2\fboxsep\relax}{%
    \strut\color{white}\bfseries\sffamily\makebox[5em]{%
       ~\thechapter\hfill}\begin{center}\huge List of Experiments\end{center}}}\vskip7pt}
\end{mdframed}
\vspace{5cm}
%
}
...
\newsavebox\speedometerbox
\newcommand\myangle{}
\newlength\tmpaht
\tikzset{%
  speedo/.style={font=\large}
}
%https://latexdraw.com/how-to-write-a-text-along-path-using-tikz-speedometer-case/
% adjusted: https://tex.stackexchange.com/a/717396/
\sbox\speedometerbox{%
  \begin{tikzpicture} [speedo]
    % Static part
    % (angle : r )
    \draw[draw=white,fill=red!50,thick] (0:2) -- (0:3.5) arc(0:45:3.5) -- (45:2) arc(45:0:2) -- cycle ;
    \draw[draw=white,fill=orange!50,thick] (90:2cm)-- (90:3.5cm) arc (90:45:3.5) -- (45:2cm) arc (45:90:2);
    \draw[draw=white,fill=orange!50,thick] (135:2cm)-- (135:3.5cm) arc (135:90:3.5) -- (90:2cm) arc (90:135:2);
    \draw[draw=white,fill=green!50,thick] (135:2cm)-- (135:3.5cm) arc (135:180:3.5) -- (180:2cm) arc (180:135:2);
    ...
    \draw[decoration={
      ...
      text align={center},
      raise=0.2cm},
    decorate] (180:2.5cm) arc (180:135:2.5); 
    ...
    \draw[decoration={
      ...
      text align={center},
      raise=0.2cm},
    decorate] (135:2.5cm) arc (135:90:2.5);
    ...
    \draw[decoration={
      ...
      text align={center},
      raise=0.2cm},
    decorate] (90:2.5cm) arc (90:45:2.5);
    ...
    \draw[decoration={
      text along path,
      text={|\footnotesize| Very High},
      text align={center},
      raise=0.2cm},
    decorate] (45:2.5cm) arc (45:0:2.5);
    
    \pgfmathsetlength \tmpaht {height("$1234567890$")+2mm}
    \path   (current bounding box.north west) coordinate (a)    ++(-\tmpaht,\tmpaht) coordinate (b) -| (current bounding box.south east)  ++(\tmpaht,0pt) -| (b);
    
  \end{tikzpicture}%
}

\NewDocumentCommand \speedometer { mm }
{% #1 location #2 index 
  \begin{tikzpicture}[speedo]
    \node [inner sep=0pt,outer sep=0pt,line width=0pt,anchor=base] {\usebox{\speedometerbox}};
    %Labels
    \draw[decoration={
      text along path,
      text={|\Large\bfseries\sffamily|#1},
      text align={center},
      raise=0.0cm},
    decorate] (-2,-1) -- (2,-1); 
    ...
    % converting quality air index into angle.
    \def\myindex{#2}
    \ifnum\myindex<7 
      % here we have 6 slices : 90 / 6 =15
      \renewcommand{\myangle}{180-\myindex*15}
      % here we have 4 slices from 7 to 10 so 
      % I divided 45/4 = 11.2 
    \else
      \ifnum\myindex<14 
        \renewcommand{\myangle}{90-((\myindex+1)*12.2-90)}
      \else
        \renewcommand{\myangle}{0}
      \fi
    \fi
    
    \fill[black!70,rotate=\myangle] (0,0.2)--(0:2.75) -- (0,-0.2)--cycle;
...
title=Box 1 $\mid$ Timeline,halign title=flush center, breakable, 
enhanced,
colback=blue!5!white,
colframe=blue!75!black,
colbacktitle=cyan!50!green,parbox = false,
coltitle=blue!25!black,
fonttitle=\bfseries,
subtitle style={boxrule=0.4pt,colback=cyan!50!red!25!white},
title=Chemistry Laboratory Checklist: What to have before coming to the lab}
%%%%%%%%%%%%%%%%%%%%%%

\newcommand{\NewNaturalElementTextFormat}[4]
{
  \CommonElementTextFormat{#1}{#2}{\huge {#3}}{#4}
}
...
\newcommand\ChapterNameLabel{ }
\renewcommand\labname{ }
\newcommand\chapterpath{ }
\newcommand\chapterpathtocontent{ }
\newcommand\chapterlabel{}
\newcommand\chapterpathtoimages
...
%\newpage\section{Lecture policies}\subfile{policies/lecturepolicies.tex} \clearpage\mbox{}\clearpage
%\newpage\section{Lab policies}\subfile{policies/labpolicies.tex} \clearpage\mbox{}\clearpage
%\newpage\section{Policies quizz}\subfile{policies/policiesquizz.tex}
%\newpage\section{Hazard Symbols}\subfile{hazard/hazard.tex}
% 
 


%\newpage\section{Some Lab Material}\subfile{material/material.tex}
%\clearpage\thispagestyle{empty}\mbox{}\clearpage
%
%%%%%CHEM 201
%\cftaddtitleline{toc}{part}{\hspace*{2cm}{\color{blue}\Large\sc\bfseries I} \hspace*{0.4cm}Atoms, molecules and composition of substances}{}
%\newpage\section{Identification of Unknown Compound: The scientific method}\subfile{scientificmethod/scientificmethod.tex}
% \newpage\section{Measurements of Mass and Volume}\subfile{measurements/measurements.tex}
%\newpage\section{Isotopes and Mass Spectroscopy}\subfile{mass-spectroscopy/mass-spectroscopy.tex}%5
%\newpage\section{Empirical Formula of an Oxide}\subfile{empiricalformula/formula.tex}
%\newpage\section{Absorption Spectrum of \ce{CoCl2}: Spectrochemistry}\subfile{spectrochemistry/spectrochemistry.tex}
%\cftaddtitleline{toc}{part}{\hspace*{2cm}{\color{blue}\Large\sc\bfseries II} \hspace*{0.4cm}Stoichiometry of chemical reactions and thermochemistry}{}
%\newpage\section{Hydrates and Their Thermal Decomposition}\subfile{therm-decomposition/decomposition.tex}
%\newpage\section{Ionic Reactions in Aqueous Solutions: Precipitation and acid-base reactions }\subfile{aq-solution/aq-solution.tex}
% \newpage\section{Acetic acid in vinegar: Titration of a weak acid}\subfile{titration/titration.tex}
%\newpage\section{Identity of Insoluble Precipitate: Gravimetry}\subfile{gravimetry/gravimetry.tex}
%\newpage\section{Thermochemistry and Hess?s Law: Heat of neutralization}\subfile{calorimetry/calorimetry.tex }
%\newpage\section{Molar Mass of a Volatile Liquid}\subfile{gas/gas.tex }
%\cftaddtitleline{toc}{part}{\hspace*{2cm}{\color{blue}\Large\sc\bfseries III} \hspace*{0.4cm}Electronic structure and chemical bonding}{}
%\newpage\section{Empirical rules for polarity and paper chromatography }\subfile{chromatography/chromatography.tex }
%\newpage\section{Solubilities Within a Family: Periodic properties of elements and compounds}\subfile{periodicproperties/periodicproperties.tex}
%\newpage\section{Molecular geometry }\subfile{geometry/geometry.tex }%
...
%%%%%CHEM 202
%
%\newpage\section{Laboratory Checklist }\subfile{checklist/checklist.tex}

\section{Isomerization of maleic acid}
\renewcommand\chapterlabel{Ch-orgo}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{isomers}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}
 
\section{Conductivity of electrolyte solutions}
\renewcommand\chapterlabel{Ch-solutions}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{conductivity}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}

\section{Softening of hard water}
\renewcommand\chapterlabel{Ch-solutions}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{hardwater}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}

\newpage
\section{Determination of the molar mass by freezing point depression}
\renewcommand\chapterlabel{Ch-solutions}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{freezingpointdepression}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}

\section{The iodine clock}
\renewcommand\chapterlabel{Ch-kinetics}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{clockreaction}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}

%\section{Kinetic characterization of an enzyme}
%\renewcommand\chapterlabel{Ch-kinetics}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{amylase}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}

\section{Testing Le Ch\^atelier's principle}
\renewcommand\chapterlabel{Ch-equilibrium}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{lechatelier}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}

\newpage 
\section{Determination of the equilibrium constant for the iron(III)-thiocyanate equilibrium}
\renewcommand\chapterlabel{Ch-equilibrium}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{equilibriumconstant}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}
 
\newpage 
\section{Determination of $K_a$ for a weak acid}
\renewcommand\chapterlabel{Ch-acidbase}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{titration-curve}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}
 
\newpage 
\section{Redox titration of hypochlorite in bleach}
\renewcommand\chapterlabel{Ch-acidbase}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{bleach}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}
 
 \newpage 
\section{Comparison of methods for measuring PH}
\renewcommand\chapterlabel{Ch-acidbase}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{relativestrenthofacids}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}
 
 \newpage 
\section{Solubility product of an iodate salt}
\renewcommand\chapterlabel{Ch-solubility}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{solubilityproduct}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}
 
  \newpage 
\section{Thermodynamics of salt dissolution}
\renewcommand\chapterlabel{Ch-thermo}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{entropy}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}
    
   \newpage 
\section{Electrochemical cells}
\renewcommand\chapterlabel{Ch-electrochem}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{electrochem}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}
    
    \newpage 
\section{Half-life of K-40}
\renewcommand\chapterlabel{Ch-nuclear}\renewcommand\ChapterNameLabel{\chapterlabel}\renewcommand\labname{nuclear}\renewcommand\chapterpathtocontent{../}\renewcommand\chapterpathtoimages{\chapterpathtocontent}\renewcommand\chapterpath{../\chapterlabel/LAB-\labname/}\subfile{\chapterpath/LAB-\labname.tex}
...
%
%\cftaddtitleline{toc}{part}{\hspace*{2cm}{\color{blue}\Large\sc\bfseries IV} \hspace*{0.4cm}Workbook}{}
% %\newpage\section{Units}
% \subfile{units1/units2.tex}    
%%\newpage\section{Units with power and switching prefixes }
%\subfile{units1/units1.tex}%2
%%\newpage\section{Classification of matter}
%\subfile{units1/matter.tex}%3
%%\newpage\section{The periodic table}
%\subfile{periodictableexperiment/experimenttable.tex}%4
%%
%%\newpage\section{Electrolytes and insoluble compounds }
%\subfile{electrolytes/electrolytes.tex}%6
%%\newpage\section{Concentrations units }
%\subfile{concentration/concentration.tex}%7
%%\newpage\section{Redox Numbers}
%\subfile{redox/redox.tex}%8
%%\newpage\section{Redox balancing}
%\subfile{redox/redox2.tex}%9
%%  \newpage\section{Types and color of radiation}
%\subfile{radiation/light1.tex}%10
%% \newpage\section{The photoelectric effect}
%\subfile{radiation/light2.tex}%11
%%\newpage\section{Bohr's model of hydrogen}
%\subfile{bohr/bohr1.tex}%12
%% \newpage\section{Quantum numbers}
%\subfile{bohr/bohr2.tex}%13
%%   \newpage\section{Electron configuration}
%   \subfile{bohr/bohr3.tex}%14
%% \newpage\section{Photoelectron spectra}
%\subfile{bohr/bohr4.tex}%15


 %%%%%%%%%%%%%%%%%In progress experiments
%\newpage\section{Solids }\subfile{solids/solids.tex }
%\cftaddtitleline{toc}{part}{\hspace*{3cm}Discussions}{}
% \newpage\section{Discussion exercises}\subfile{discussion/discussion.tex}%17
 %%%%%%%%%%%%%%%%%In progress experiments
...
%\clearpage\mbox{}\clearpage
%\clearpage\mbox{}\clearpage
\subfile{./periodictable/periodictableLAB.tex}\newpage
\clearpage\mbox{}\clearpage

%\thispagestyle{empty}\subfile{cover/back.tex}
