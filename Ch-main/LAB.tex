...
\renewcommand\labname{../\texbooklabel/LAB-isomers}\renewcommand\texbooklabel{Ch-orgo}\renewcommand\pathtofiles{../\texbooklabel/}\section{Isomerization of maleic acid}\subfile{../\texbooklabel/Lab-isomers/LAB-isomers.tex }
\renewcommand\labname{../\texbooklabel/LAB-conductivity}\renewcommand\texbooklabel{Ch-solutions}\renewcommand\pathtofiles{../\texbooklabel/}\section{Conductivity of electrolyte solutions}\subfile{../\texbooklabel/Lab-conductivity/LAB-conductivity.tex }
\renewcommand\labname{../\texbooklabel/LAB-hardwater}\renewcommand\texbooklabel{Ch-solutions}\renewcommand\pathtofiles{../\texbooklabel/}\section{Softening of hard water}\subfile{../\texbooklabel/Lab-hardwater/LAB-hardwater.tex }
\newpage
\renewcommand\labname{../\texbooklabel/LAB-freezingpointdepression}\renewcommand\texbooklabel{Ch-solutions}\renewcommand\pathtofiles{../\texbooklabel/}\section{Determination of the molar mass by freezing
point depression}\subfile{../\texbooklabel/Lab-freezingpointdepression/LAB-freezingpointdepression.tex }
\renewcommand\labname{../\texbooklabel/LAB-clockreaction}\renewcommand\texbooklabel{Ch-kinetics}\renewcommand\pathtofiles{../\texbooklabel/}\section{The iodine clock}\subfile{../\texbooklabel/Lab-clockreaction/LAB-clockreaction.tex }
\renewcommand\labname{../\texbooklabel/LAB-amylase}\renewcommand\texbooklabel{Ch-kinetics}\renewcommand\pathtofiles{../\texbooklabel/}\section{Kinetic characterization of an enzyme}\subfile{../\texbooklabel/Lab-amylase/LAB-amylase.tex }

\renewcommand\labname{../\texbooklabel/LAB-lechatelier}\renewcommand\texbooklabel{Ch-equilibrium}\renewcommand\pathtofiles{../\texbooklabel/}\section{Testing Le Ch\^atelier's principle}\subfile{../\texbooklabel/Lab-lechatelier/LAB-lechatelier.tex }
\newpage \renewcommand\labname{../\texbooklabel/LAB-equilibriumconstant}\renewcommand\texbooklabel{Ch-equilibrium}\renewcommand\pathtofiles{../\texbooklabel/}\section{Determination of the equilibrium constant for
the iron(III)-thiocyanate equilibrium}\subfile{../\texbooklabel/Lab-equilibriumconstant/LAB-equilibriumconstant.tex }
\newpage \renewcommand\labname{../\texbooklabel/LAB-titration-curve}\renewcommand\texbooklabel{Ch-acidbase}
\renewcommand\pathtofiles{../\texbooklabel/}\section{Determination of $K_a$ for a weak acid}\subfile{../\texbooklabel/Lab-titration-curve/LAB-titration-curve.tex }
\newpage  \renewcommand\pathtofiles{../\texbooklabel/}\section{Redox titration of hypochlorite in bleach}\subfile{../\texbooklabel/Lab-bleach/LAB-bleach.tex }
\newpage  \renewcommand\pathtofiles{../\texbooklabel/}\section{Comparison of methods for measuring PH}\subfile{../\texbooklabel/Lab-relativestrenthofacids/LAB-relativestrenthofacids.tex }
\newpage \renewcommand\labname{../\texbooklabel/LAB-solubilityproduct}\renewcommand\texbooklabel{Ch-solubility}\renewcommand\pathtofiles{../\texbooklabel/}\section{Solubility product of an iodate salt}\subfile{../\texbooklabel/Lab-solubilityproduct/LAB-solubilityproduct.tex }
\newpage \renewcommand\labname{../\texbooklabel/LAB-entropy}\renewcommand\texbooklabel{Ch-thermo}\renewcommand\pathtofiles{../\texbooklabel/}\section{Thermodynamics of salt dissolution}\subfile{../\texbooklabel/Lab-entropy/LAB-entropy.tex }
\newpage\renewcommand\labname{../\texbooklabel/LAB-electrochem}\renewcommand\texbooklabel{Ch-electrochem}\renewcommand\pathtofiles{../\texbooklabel/}\section{Electrochemical cells}\subfile{../\texbooklabel/Lab-electrochem/Lab-electrochem.tex }
\renewcommand\labname{../\texbooklabel/LAB-nuclear}\renewcommand\texbooklabel{Ch-nuclear}\renewcommand\pathtofiles{../\texbooklabel/}\section{Half-life of K-40}\subfile{../\texbooklabel/Lab-nuclear/Lab-nuclear.tex }
