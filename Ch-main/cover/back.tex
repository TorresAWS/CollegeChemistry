...
\providetoggle{chem121}\settoggle{chem121}{\chemversionhealthalied}\iftoggle{chem121}{{\fontsize{50}{60}\selectfont \color{blueXIIdark} GOB Chemistry}}{ {\fontsize{50}{60}\selectfont \color{blueXIIdark} College Chemistry}}
...
\vfill
\large\color{black}
This set of lectures present content in a simple and clear way, while including numerous worked examples and many problems with solution. In particular, this current version of the manuscript contains more than 90 solved problems and more than 200 problems with solution. It also contains numerous diagrams and graphs specifically developed to clarify the content.
The organization of the note intends to help the reader digest the large content typically covered in a GOB or college Chemistry class. Every part ends with a review quiz that assesses content. 
\thispagestyle{empty}
\end{titlepage}
