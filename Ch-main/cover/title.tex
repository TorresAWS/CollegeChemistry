...
\providetoggle{chem121}\settoggle{chem121}{\chemversionhealthalied}\iftoggle{chem121}{ \titlenew}{ \titlenew}
\\
...
\begin{flushright}(with solutions) \end{flushright}
}{}
\vfill
\large\color{black}
\begin{tabularx}{\textwidth}{Xr}
%& \textbf{\Huge Daniel Torres}\vspace{0.8cm}\\
& \textbf{\Large The Open Education Initiative at CUNY}\vspace{0.8cm}\\
 & \includegraphics[width=0.1\textwidth]{cover/cc}\\[0.5\baselineskip] \\
&   \today \hspace{0.5cm} (\currenttime)
\end{tabularx}
\vspace{2cm}
