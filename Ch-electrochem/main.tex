...
%\end{tikzpicture}
 ...
 % Draw back of vessel 1
  ...
  %  \draw[line join = round, thick] (1,2) -- (1,2.5) -- (4.5,2.5) -- (4.5,2);
   ...
   \ifnum  0 = #9 { \draw[fill=batteryRightElectrode, shift={(-1.3em,-7.1em)}] (4.9,2) rectangle (5,1.4) node [shift={( 0.7em, 1.0em)}] {\small Pt};\draw[shift={(12em,-4em)},left color=blue,right color=blue,middle color=white, fill opacity=0.25] (0,-0) .. controls (0,-.1) and (.4,-0.1) .. (.5,0) -- (.5,2.5) --(.8,2.5) -- (.8,2.7) --(.5,2.7)  --(.5,2.8)      arc(0:180:.25)    -- cycle; \draw[->, shift={(12.6em,-3.7em)}]  (1.2,2.5) --(.8,2.5)  node[ text width=1cm,align=center, shift={(2em,0em)}] {\Helectrodelabel};  \draw (4.5,-1.75) node {#3} node[shift={(1em,11em)}]  {\Large $+$} ; } \else {  \draw[fill=batteryRightElectrode, shift={(-.7em,0)}] (4.5,2) rectangle (5,-1) node[shift={(-.7em,3.7em)}]  {#3} node[shift={(-.8em, 7em)}]  {#7} ; } \fi
