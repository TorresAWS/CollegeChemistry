...
%\end{tikzpicture}
 ...
 % Draw back of vessel 1
    ...
    \draw[fill=batteryLeftElectrode, shift={(.7em,0)}] (0.5,2) rectangle (1.0,-1) node[shift={(-.7em,3.7em)}] {#2} node[shift={(-.8em, 7em)}]  {#6}; % SIGN
  ...
  %  \draw[line join = round, thick] (1,2) -- (1,2.5) -- (4.5,2.5) -- (4.5,2);
   ...
   \ifnum  0 = #9 { \draw[fill=batteryRightElectrode, shift={(-1.3em,-7.1em)}] (4.9,2) rectangle (5,1.4) node [shift={( 0.7em, 1.0em)}] {\small Pt};\draw[shift={(12em,-4em)},left color=blue,right color=blue,middle color=white, fill opacity=0.25] (0,-0) .. controls (0,-.1) and (.4,-0.1) .. (.5,0) -- (.5,2.5) --(.8,2.5) -- (.8,2.7) --(.5,2.7)  --(.5,2.8)      arc(0:180:.25)    -- cycle; \draw[->, shift={(12.6em,-3.7em)}]  (1.2,2.5) --(.8,2.5)  node[ shift={(2em,0em)}] {\Helectrodelabel};  \draw (4.5,-1.75) node {#3} node[shift={(1em,11em)}]  {\Large $+$} ; } \else {  \draw[fill=batteryRightElectrode, shift={(-.7em,0)}] (4.5,2) rectangle (5,-1) node[shift={(-.7em,3.7em)}]  {#3} node[shift={(-.8em, 7em)}]  {#7} ; } \fi
...
\newcommand{\SingleElectrode}[1]{
         ...
         \draw[line join = round, thick,   shift={(-1.5em,0em)}]   (4.5,2.5) -- (4.5,-.3); \draw[fill=batteryRightElectrode, shift={(-3.0em,-7.1em)}] (4.9,2) rectangle (5,1.4) node [shift={( 0.7em, 1.0em)}] {\small Pt};  
         \draw[->, shift={(12.6em,-3.7em)}]  (1.2,2.5) --(.8,2.5)  node[ shift={(2em,0em)}] {\ElectrodeGaslabel}; 
          \draw (4.5,-1.75) node {\ElectrodeSolutionlabel}  ; 
             \end{scope}} \else { \draw[fill=ElectrodeSolid, shift={(.7em,0)}] (0.5,2) rectangle (1.0,-1) node[rotate=90,shift={(4em,0.7em)}] {\ElectrodeSolidlabel} ;  \draw (0.9,-1.75) node {\ElectrodeSolutionlabel}  ;} \fi
\begin{scope}[shift={(0cm,0)}]
    \draw (0,0) to [controls=+(90:0.5) and +(90:0.5)] (2,0);
    \draw[fill=ElectrodeSolution, fill opacity=0. 5] (0,-0.5) to    [controls=+(90:0.5) and +(90:0.5)] (2,-0.5);
     \draw (0,0) .. controls +(-90:0.5) and +(-90:0.5) .. (2,0);
