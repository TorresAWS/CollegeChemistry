...
\import{../\chapterlabel/problems/problems/}{Problems-Units-and-measurements.2.B}
\end{question}
   \begin{Form}
   \TextField[multiline,backgroundcolor=gray!20,borderwidth=0,width=0.43\textwidth  ,height=115pt, name=\the\value{numA}]  { }\end{Form}
\begin{solution}
\import{../\chapterlabel/problems/problems/}{Problems-Units-and-measurements.2.B.answer}
\hspace{0.1cm}
\end{solution}
\stepcounter{numA}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
