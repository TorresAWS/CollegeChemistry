...
\node[name=Group1, above of=H, GroupLabel] {1 \hfill IA};
  ...
  \node[name=Group17, above of=F, GroupLabel] {17 \hfill VIIA};
  \node[name=Group18, above of=He, GroupLabel] {18 \hfill VIIIA};
	\draw [<-, thick, -latex,postaction={decorate,decoration={reverse path,raise=-1em,text along path,text align=center,text={|\myshiftb|Metallic Character  increases}}}]   (50 em ,-45 em) to (0,-45em )  ;
 		 	\draw [<-, thick, -latex,postaction={decorate,decoration={reverse path,text along path,text align=center,text={|\myshiftb|Metallic Character increases}}}]    		(-8em,0em )  to   (-8 em ,-40 em);
