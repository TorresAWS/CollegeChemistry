...
%%%%%%%%%%%%NOT FOR 121
\newpage\section{Quantum mechanics}\import{../\chapterlabel/files/}{SectionIntro-Quantum-mechanics-and-electronic-structure}
\sloppy\begin{description}
...
\section{Photoelectron spectroscopy of atoms}%%%%NOT FOR 121
