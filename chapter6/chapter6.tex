...
\begin{description}
\item[\docfilehook{Valence electrons}{Valence electrons}] The electrons of an atom can be classified into core electrons and valence electrons. Valence electrons are weakly bound to the nucleus being involved in chemical bonds. Core electrons are strongly bound to the nucleus playing a less important role in the chemical properties of the element. The number of valence electrons in an atom corresponds to the group number. For example, hydrogen \ce{H} belong to the group IA and hence has one valence electrons. Similarly, oxygen \ce{O} belongs to the group VIA and therefore it has six valence electrons.
