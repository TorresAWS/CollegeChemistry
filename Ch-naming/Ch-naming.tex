...
\label{ch:naming}
            ...
            \begin{marginfigure}
\begin{tikzpicture} \node (a) at (0,0) {\includegraphics[width=4cm]{../Ch-naming/figure1}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]a.south east) {\textsuperscript{\textcopyright} Pixnio} ;
\end{tikzpicture}
\label{fig:naming1}
\end{marginfigure}
...
%      \includegraphics{../Ch-naming/figure2}
%      \label{image51}
...
\sloppy 
%\begin{marginfigure}%%%%%%%MARGIN FIGURE
%      \includegraphics{../Ch-naming/figure4}
%      \label{fig:marginfig}
...
\sloppy 
%\begin{marginfigure}%%%%%%%MARGIN FIGURE
%      \includegraphics{../Ch-naming/figure3}
%      \label{fig:marginfig}
