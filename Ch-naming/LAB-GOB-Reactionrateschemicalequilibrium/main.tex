...
\renewcommand\ChapterNameLabel{Ch-equilibrium}\renewcommand\labname{Reactionrateschemicalequilibrium}\renewcommand\chapterpathtocontent{../../}\renewcommand\chapterpath{../LAB-GOB-\labname/}\subfile{./\labname.tex}
