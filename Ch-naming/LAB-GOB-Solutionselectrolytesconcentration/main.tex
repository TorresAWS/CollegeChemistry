...
\renewcommand\ChapterNameLabel{Ch-electrolytes}\renewcommand\labname{Solutionselectrolytesconcentration}\renewcommand\chapterpathtocontent{../../}\renewcommand\chapterpath{../LAB-GOB-\labname/}\subfile{./\labname.tex}
