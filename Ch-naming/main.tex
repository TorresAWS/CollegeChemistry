...
%\newcommand{\chapterpicturelabel}[1]{\def\thechapterpicturelabel{#1}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
>>>>>>> 1cd82d8e01f2360d4e160e7e6256298fbbeb23b9:Ch-naming/LAB-GOB-Densityandspecificgravity/main.tex
...
\newcommand\ChapterNameLabel{Ch-Naming} 			%%Chapter name eg Ch-orgo
...
\renewcommand\ChapterNameLabel{Ch-measurements}\renewcommand\labname{Densityandspecificgravity}\renewcommand\chapterpathtocontent{../../}\renewcommand\chapterpath{../LAB-GOB-\labname/}\subfile{./\labname.tex}
