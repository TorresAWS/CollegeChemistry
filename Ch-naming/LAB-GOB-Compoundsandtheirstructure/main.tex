...
\renewcommand\ChapterNameLabel{Ch-electronicstructure}\renewcommand\labname{Compoundsandtheirstructure}\renewcommand\chapterpathtocontent{../../}\renewcommand\chapterpath{../LAB-GOB-\labname/}\subfile{./\labname.tex}
