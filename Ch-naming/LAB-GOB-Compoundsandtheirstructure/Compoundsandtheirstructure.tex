...
\midrule
\ce{AB2} &  Linear      &  $180^{\circ}$    &   \begin{minipage}{.1\textwidth}\includegraphics[width=15mm, height=15mm]{../LAB-GOB-Compoundsandtheirstructure/geom1}\end{minipage}   \\

\ce{AB3E} &  Trigonal pyramidal    &  $109^{\circ}$    &   \begin{minipage}{.1\textwidth}\includegraphics[width=15mm, height=15mm]{../LAB-GOB-Compoundsandtheirstructure/geom5}\end{minipage} \\
\ce{AB3} &  Trigonal Planar      &  $120^{\circ}$    &   \begin{minipage}{.1\textwidth}\includegraphics[width=15mm, height=15mm]{../LAB-GOB-Compoundsandtheirstructure/geom2}\end{minipage}\\

\ce{AB2E2} &  Bent    &  $109^{\circ}$    &   \begin{minipage}{.1\textwidth}\includegraphics[width=15mm, height=15mm]{../LAB-GOB-Compoundsandtheirstructure/geom6}\end{minipage}\\
\ce{AB2E} &  Bent      &  $120^{\circ}$    &   \begin{minipage}{.1\textwidth}\includegraphics[width=15mm, height=15mm]{../LAB-GOB-Compoundsandtheirstructure/geom3}\end{minipage}\\

\ce{AB5} &  Trigonal bipyramidal    &  $90^{\circ}$, $120^{\circ}$,$180^{\circ}$    &   \begin{minipage}{.1\textwidth}\includegraphics[width=15mm, height=15mm]{../LAB-GOB-Compoundsandtheirstructure/geom7}\end{minipage}\\
\ce{AB4} &  Tetrahedral      &  $109^{\circ}$    &   \begin{minipage}{.1\textwidth}\includegraphics[width=15mm, height=15mm]{../LAB-GOB-Compoundsandtheirstructure/geom4}\end{minipage} \\

 \ce{AB6} &  Octahedral   &  $90^{\circ}$, $180^{\circ}$,$180^{\circ}$    &   \begin{minipage}{.1\textwidth}\includegraphics[width=15mm, height=15mm]{../LAB-GOB-Compoundsandtheirstructure/geom8}\end{minipage}\\
\bottomrule
...
\item Draw the lewis structure of the following compounds: \ce{NF3},  \ce{CFH3},  \ce{BeCl2}.
\begin{multicols}{3}
...
\item Draw the lewis structure of the following compounds: \ce{H2O},  \ce{HF},  \ce{HCl}.
\begin{multicols}{3}
 \begin{center}\begin{tikzpicture}
\draw[step=.45cm,gray,very thin] (-2,-2) grid (2,2);
\end{tikzpicture}\end{center}
...
\newgeometry{right=1in, bottom=1in, left=1in, top=1in}
...
\begin{landscape}
\begin{centering}
\begin{tcolorbox}[tab2,tabularx={X|>{\hsize=5cm}Y| >{\hsize=2.9cm}Y |Y|Y|Y|Y}]%%%% FANCY COLOR TABLE
\Large  Formula &
...
\Large Angles &
\Large Polar?  \\\hline
\Huge \ce{PCl3}\rot{\hspace{3.8cm}}&   &   &   &  & &  \\\hline 
\Huge \ce{ClO2^{-}}\rot{\hspace{3.8cm}} &   &   &   &  & &  \\\hline
 \Huge \ce{BrO2^-}\rot{\hspace{3.8cm}}&   &   &   &  & & \\\hline 
 \Huge \ce{CCl3^-}\rot{\hspace{3.8cm}} &   &   &   &  & &  \\\hline 
