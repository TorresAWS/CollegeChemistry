...
\renewcommand\ChapterNameLabel{Ch-mole}\renewcommand\labname{Chemicalreactionsandequations}\renewcommand\chapterpathtocontent{../../}\renewcommand\chapterpath{../LAB-GOB-\labname/}\subfile{./\labname.tex}
