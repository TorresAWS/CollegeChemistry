...
\chapter[Reactions in solution  ]{Reactions in solution }
 ...
 \begin{marginfigure}
\begin{tikzpicture} \node (a) at (0,0) {\includegraphics[width=4cm]{../Ch-electrolytes/figure1}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]a.south east) {\textsuperscript{\textcopyright} PngImg} ;
\end{tikzpicture}
...
\begin{tikzpicture} \node (a) at (0,0) {\includegraphics{../Ch-electrolytes/figure3}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]a.south east) {\textsuperscript{\textcopyright} wikipedia} ;
\end{tikzpicture}
...
Molecules with an even electron distribution are non-polar as they have no permanent dipole moment. An example of this is \ce{H2} molecule. Differently,  \ce{HF} is a polar molecule, as \ce{F} concentrates more the electron density of the molecule than \ce{H}. The polar nature of substances--with a permanent dipole moment--is related to miscibility and molecules with similar polar character will mingle and mix together creating a single visible phase. As an example, water (\ce{H2O}, polar) and methanol (\ce{CH3OH}, polar) will mix together. Differently, water (polar) and oil (non-polar) are immiscible due to its different polar nature and they will not mix. Even if the rules or polarity are based of the nature and structure of the molecule, one can use very simple empirical rules to classify molecules as polar or non-polar. These rules work in general well for the case of diatomic and very large molecules:
\begin{itemize}
   \item  Diatomic molecules made of the same element (e.g. \ce{H2}) are non-polar.
      \item  Diatomic molecules made of different elements (e.g. \ce{HI}) are polar.
   \item Poliatomic molecules (with more than four atoms) made of C and H (e.g. \ce{CH4}) are in general non-polar.
   \item Poliatomic molecules (with more than four atoms) containing C, H and a different atom (e.g. \ce{CH3F}) are in general polar.
 \end{itemize}
\begin{example} %%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX
Classify the following molecules as polar or nonpolar: \ce{H2}, \ce{HCl}, \ce{CH3CH3}, and \ce{CH3CH2Cl}.
\\
\textlcsc{ \textcolor{dgreen}{\Large \textbf{Solution}} }\\
\ce{H2} is a non-polar molecule, being a diatomic molecule containing two atoms of the same element. Differently \ce{HCl} is polar. \ce{CH3CH3} is a non-polar poliatomic molecule made of C and H atoms, whereas \ce{CH3CH2Cl} is polar.
\\
\faDiamond\ \textlcsc{ \textcolor{dgreen}{\Large \textbf{Study Check}} }\\
Classify the following molecules as polar or nonpolar: \ce{HF}, \ce{Cl2}, \ce{C2H4}, and \ce{C2H3Cl}.
\\
\flushright  {\small Answer: polar, nonpolar, nonpolar, polar.}
\end{example}%%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX
...
\begin{example} %%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX
Use polarity arguments to indicate if the following substances will mix: (a) \ce{H2O_{(g)}} and \ce{CH4_{(g)}}; (b) \ce{H2O_{(g)}} and \ce{HCl_{(g)}}
\\
\textlcsc{ \textcolor{dgreen}{\Large \textbf{Solution}} }\\
(a) Water and methane (\ce{CH4}) will not mix, as water is a polar molecule and \ce{CH4} (methane) is nonpolar. (b) They will mix as HCl is a polar molecule and so is water.
\\
\faDiamond\ \textlcsc{ \textcolor{dgreen}{\Large \textbf{Study Check}} }\\
Use polarity arguments to indicate if the following substances will mix: (a) \ce{H2O_{(l)}} and \ce{CH3Cl_{(l)}}; (b) \ce{CH3Cl_{(l)}} and \ce{CCl4_{(l)}}
\\
...
\end{example}%%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX
     ...
     \item[\docfilehook{Concentration of solutions}{Concentration of solutions}]                       
...
\end{equation*}
\begin{example} %%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX
A NaCl solution is prepared by mixing 4g of \ce{NaCl} (MW=58.4$g/mol$) with 50 g of water until a final volume of 52mL of solution. Calculate:  (a) the mass percent (m/m) concentration; (b) the molarity.
\\
\textlcsc{ \textcolor{dgreen}{\Large \textbf{Solution}} }\\
...
%\begin{marginfigure}%%%%%%%% MARGIN FIGURE
%\includegraphics{../Ch-electrolytes/figure4}
...
\\
\flushright  {\small Answer: $83.3$g.}
\end{example}%%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX



%\begin{marginfigure}%%%%%%%% MARGIN FIGURE
%\includegraphics{../Ch-electrolytes/figure2}
...
%\begin{marginfigure}%%%%%%%% MARGIN FIGURE
%\includegraphics{../Ch-electrolytes/figure5}
...
\item[\docfilehook{Soluble and insoluble salts}{Soluble and insoluble salts}] 
Soluble compounds dissolve in water, whereas insoluble compounds do not. For example, barium chromate (\ce{BaCrO4_{(s)}}) is an insoluble salt. How do we know that? The Table bellow will help you predict the solubility of a salt. In order to do this, you need to start by assess the right ion (the anion, \ce{CrO4^{2-}}) located on the left column of the Table below. After that you need to assess the left ion (the cation, \ce{Ba^{2+}}) located on the right column. If you follow this, you will see that chromate is insoluble and barium is not part of any exception. Let us predict for example the soluble/insoluble nature of \ce{CaSO4}, calcium sulfate. We start by looking for \ce{SO4^{2-}} in the left column to find out is soluble. Next we continue in the same line as \ce{SO4^{2-}} and look for the ion in the left \ce{Ca^{2+}}. In conclusion, even when \ce{SO4^{2-}}  is soluble, when combined with \ce{Ca^{2+}}, we have that \ce{CaSO4} is insoluble, and overall \ce{CaSO4_{(s)}} is insoluble.
\begin{example} %%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX
Predict the soluble/insoluble nature of the following compounds: (a) \ce{K2CO3}, (b) \ce{NaNO3} and (c) \ce{Ca(OH)2}.
\\
\textlcsc{ \textcolor{dgreen}{\Large \textbf{Solution}} }\\
(a) \ce{K2CO3_{(aq)}} is soluble, as \ce{CO3^{-2}} is insoluble but when combined with \ce{K+} the salt becomes soluble. (b) All nitrates are soluble without exceptions. (c) \ce{Ca(OH)2_{(aq)}} is soluble.
\\
\faDiamond\ \textlcsc{ \textcolor{dgreen}{\Large \textbf{Study Check}} }\\
Predict the soluble/insoluble nature of the following compounds: (a) \ce{Li3PO4}, (b) \ce{Na2S} and (c) \ce{AgCl}.
  \\
\flushright {\small Answer: (a) \ce{Li3PO4_{(aq)}} soluble, (b) \ce{Na2S_{(aq)}} soluble and (c) \ce{AgCl_{(s)}} insoluble.}
\end{example}%%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX


\begin{figure*}[h]
\begin{center}
\refstepcounter{table} \label{tab:electrolytes1}
...
\begin{example} %%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX
For the following chemicals indicate whether you will have in the solution (a) only ions, (b) ions and some molecules, or (c) molecules: \ce{NH3}, \ce{KOH}, and \ce{C12H22O11}.\\
\textlcsc{ \textcolor{dgreen}{\Large \textbf{Solution}} }\\
Ammonia (\ce{NH3}) is a weak electrolyte and a solution of ammonia will contain ions and well as ammonia molecules. Differently \ce{KOH} is a strong electrolyte and in solution you would find only ions (\ce{K^+} and \ce{OH^-}). Sucrose (\ce{C12H22O11}) is a nonelectrolyte and in solution you will find molecules.\\
 \faDiamond\ \textlcsc{ \textcolor{dgreen}{\Large \textbf{Study Check}} }\\
For the following chemicals indicate whether you will have in the solution only ions, ions and some molecules, or  molecules: (a) \ce{H2SO4}, \ce{HNO3} and \ce{CH3OH}. 
  \\
\flushright  {\small Answer: (a) ions, (b) ions (c) molecules.}
\end{example}%%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX
...
\begin{figure*}[h]
\begin{center}
\refstepcounter{table} \label{tab:electrolytes2}
\fontfamily{ppl}\selectfont
\begin{tabular}{lllll}
\rowcolor{black!45}
\toprule
...
(a) \ce{ Fe_{(s)} +   Cu^{+2}_{(aq)} -> Fe^{+2}_{(aq)} +   Cu_{(s)} } \\
...
\item[\docfilehook{Precipitation reactions}{}] Precipitation reactions result in an insoluble chemical. An example would be:\\
\ce{K2CrO4_{(aq)} + Ba(NO3)2_{(aq)} -> BaCrO4_{(s)} v + 2KNO3_{(aq)}    \textcolor{red}{ (precipitation reaction) }      }\\
...
\faDiamond\ \textlcsc{ \textcolor{dgreen}{\Large \textbf{Study Check}} }\\
Write down the ionic equation and net ionic for the following formula equation:
\begin{center}\ce{ AgNO3_{(aq)} + NaBr_{(aq)}  -> AgBr_{(s)} v  +  NaNO3_{(aq)}   }\end{center}
\flushright  {\small Answer:     \ce{ Ag^{+}_{(aq)} + NO3^{-}_{(aq)} + Na^{+}_{(aq)} + Br^{-}_{(aq)}  -> AgBr_{(s)} v  +  Na^{+}_{(aq)} + NO3^{-}_{(aq)}   } ;  \ce{ Ag^{+}_{(aq)} + Br^{-}_{(aq)}  -> AgBr_{(s)} v     }     }
\end{example}%%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX
...
\begin{center}\ce{2Al_{(s)} + 3Cu^{2+}_{(aq)} -> 2Al^{3+}_{(aq)} + 3Cu_{(s)} }    \textcolor{red}{ (redox reaction) }      \end{center}
We have that neither \ce{Al_{(s)}} or \ce{Cu^{2+}_{(aq)}} are an acid or a base. Also there is no product precipitate. Hence, this reaction is not an acid-base reaction or a precipitation reaction. This is a redox reaction, as we have \ce{Al} in two different states: as metallic \ce{Al_{(s)}} and as ionic  \ce{Al^{3+}_{(aq)}}, which result from the loss of an electron. In redox reaction there is always elements in the chemicals that lose electrons and chemicals winning electrons.
\sloppy 
\begin{description}
...
\item[\docfilehook{Rules to calculate redox numbers}{}] 
...
Now let us compare the redox number of \ce{Cu}. In the reactant side we have \ce{Cu_{(aq)}^{+2}} with redox of $\text{II}$. In the product side we have \ce{Cu_{(s)}} with zero redox number. Cu has undergone reduction as its redox number has decreases. This means it has gained electrons, in particular two electrons: 
...
\begin{center}\ce{ Cr2O7^{2-} + 14 H^+ + 6 e^- ->  2Cr^{3+} + 7 H2O     \textcolor{red}{ (reduction) }   }\end{center}
...
\begin{center}\ce{ SO3^{2-} + H2O   ->  SO4^{2-} + 2 H^+ + 2 e^-    \textcolor{red}{ (oxidation) }   }\end{center}
In order to add both half-reactions as the reduction involves two electrons and the oxidation six, we will have to multiply the reduction half-reaction by three:
 \begin{center}
$1\cdot \big($ \ce{ Cr2O7^{2-} + 14 H^+ + 6 e^- ->  2 Cr^{3+} + 7 H2O  } $\big)$ \hspace*{0pt}\hfill  \textcolor{red}{ (reduction) }\\
 $3\cdot \big($\ce{ SO3^{2-} + H2O   ->  SO4^{2-} + 2 H^+ + 2 e^- }$\big)$  \hspace*{0pt}\hfill  \textcolor{red}{ (oxidation) } \\
\rule{10.5cm}{0.4pt}$+$\\
...
\faDiamond\ \textlcsc{ \textcolor{dgreen}{\Large \textbf{Study Check}} }\\
Balance the following redox in acidic medium:
\begin{center}\ce{  Cr2O2^{-7}_{(aq)} + NO2^{-}_{(aq)} -> Cr^{3+}_{(aq)} + NO3^-_{(aq)}    }\end{center}
\flushright {\small Answer: \ce{3NO2_{(aq)} + 8H^+_{(aq)} + Cr2O2^{7-}_{(aq)} -> 3NO3^-_{(aq)} + 2Cr^{3+}_{(aq)} + 4H2O_{(l)}}.}
\end{example}%%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX
