...
\renewcommand\ChapterNameLabel{Ch-electrolytes}\renewcommand\labname{Solubleandinsolublesalts}\renewcommand\chapterpathtocontent{../../}\renewcommand\chapterpath{../LAB-GOB-\labname/}\subfile{./\labname.tex}
