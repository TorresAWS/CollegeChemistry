...
<<<<<<< HEAD:Ch-thermochemistry/LAB-GOB-Energyandmatter/main.tex
...
\usepackage{paralist}
>>>>>>> origin/Ch-solids:Ch-solids/main.tex
\usepackage{graphicx}
\usepackage{mathpazo}
\usepackage[us,12hr]{datetime} 
\usepackage{lscape}
...
\newcommand\ChapterNameLabel{Ch-solids} 			%%Chapter name eg Ch-orgo
...
\renewcommand\ChapterNameLabel{Ch-thermochemistry}\renewcommand\labname{Energyandmatter}\renewcommand\chapterpathtocontent{../../}\renewcommand\chapterpath{../LAB-GOB-\labname/}\subfile{./\labname.tex}
