...
<<<<<<< HEAD:Ch-thermochemistry/main.tex
\usepackage{paralist}
...
>>>>>>> 91c5dc5f8b6e3c6ae07d40b94453e6bda2c25c6c:Ch-naming/LAB-GOB-Chemistryandmeasurements/main.tex
\usepackage{graphicx}
\usepackage{mathpazo}
\usepackage[us,12hr]{datetime} 
\usepackage{lscape}
...
\newcommand\ChapterNameLabel{Ch-thermochemistry} 			%%Chapter name eg Ch-orgo
...
\renewcommand\ChapterNameLabel{Ch-measurements}\renewcommand\labname{Chemistryandmeasurements}\renewcommand\chapterpathtocontent{../../}\renewcommand\chapterpath{../LAB-GOB-\labname/}\subfile{./\labname.tex}
