...
\begin{marginfigure}
      \begin{tikzpicture} \node (a) at (0,0) {\includegraphics[width=4cm]{../Ch-Gas/figure1}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]a.south east) {\textsuperscript{\textcopyright} PngImg} ;
\end{tikzpicture}
\end{marginfigure}
...
%\includegraphics{../Ch-Gas/figure2}
...
%\begin{marginfigure}[0cm]%%%%%%%MARGIN FIGURE
%\includegraphics{../Ch-Gas/figure4}
...
\stepcounter{figurenewcounter}   \refstepcounter{figure}  \label{Fig:{\chapterlabel}\thefigurenewcounter}
 ...
 \GasTable 
	  \begin{tikzpicture} 
	  \node[text width=12cm, fontscale=.2,shift={(12em,-13em)}] at (-1em,5em) { \begin{bf}\color{black}\bfseries\large Figure \ref{Fig:{\chapterlabel}\thefigurenewcounter} \end{bf} All gas elements };
\end{tikzpicture}
\end{minipage}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   \begin{tikzpicture} \node (a) at (0,0) {\includegraphics[width=4cm, height=4cm]{../Ch-Gas/figure2}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]a.south east) {\textsuperscript{\textcopyright} www.wallpaperflare.com} ;
%\node[text width=5cm] at ([yshift=0.2cm]a.north) {\mytriangle{red}Oxygen oxidizing is a gas};
%\end{tikzpicture}
\begin{tikzpicture} \node (a) at (0,0) {\includegraphics[width=4.5cm, height=4.5cm]{../Ch-Gas/figure6}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]a.south east) {\textsuperscript{\textcopyright} www.wallpaperflare.com} ;
\node[text width=5cm] at ([yshift=0.2cm]a.north) {\mytriangle{red}Chlorine reactive is a gas};
\end{tikzpicture}
\begin{tikzpicture} \node (a) at (0,0) {\includegraphics[width=5cm, height=3cm]{../Ch-Gas/figure7}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]a.south east) {\textsuperscript{\textcopyright} wikipedia} ;
...
\resizebox{.9\textwidth}{!}{
	  \begin{tikzpicture} \node (a) at (0,0) {\includegraphics[width=4.5cm, height=4.5cm]{../Ch-Gas/figure3}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]a.south east) {\textsuperscript{\textcopyright} wikipedia} ;
\node[text width=5cm] at ([yshift=0.8cm]a.north) {\baselineskip=8pt \mytriangle{red}{\small A barometer used to measure the atmospheric pressure}};
 ...
 \node (b) at (6cm,0) {\includegraphics[width=4.5cm, height=4.5cm]{../Ch-Gas/figure4}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]b.south east) {\textsuperscript{\textcopyright} wikipedia} ;
\node[text width=4cm] at ([yshift=0.8cm]b.north) {\mytriangle{red}{\small A manometer used to measure gas pressures}};

 \node (c) at (12cm,0) {\includegraphics[width=5cm, height=5cm]{../Ch-Gas/figure5}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]c.south east) {\textsuperscript{\textcopyright} PxFuel} ;
\node[text width=4cm] at ([yshift=0.8cm]c.north) {\mytriangle{red}{\small A pressure gauge}};
\node[text width=12cm, fontscale=.2,shift={(12em,-13em)}] at (-1em,5em) { \begin{bf}\color{black}\bfseries\large Figure \ref{Fig:{\chapterlabel}\thefigurenewcounter} \end{bf} Pressure measuring devices };
...
\end{where}
%\begin{marginfigure}[0cm]%%%%%%%MARGIN FIGURE
%\includegraphics[width=\linewidth,scale=0.5]{../Ch-Gas/figure6}
...
%\begin{marginfigure}[0cm]%%%%%%%MARGIN FIGURE
%\includegraphics {../Ch-Gas/figure7}
...
%\begin{marginfigure}[0cm]%%%%%%%MARGIN FIGURE
%\includegraphics{../Ch-Gas/figure5}
...
\end{scope}
	  \node[text width=12cm, fontscale=.2,shift={(12em,-13em)}] at (-1em,5em) { \begin{bf}\color{black}\bfseries\large Figure \ref{Fig:{\chapterlabel}\thefigurenewcounter} \end{bf} A visual representation of Dalton's law of partial pressure: after adding two different gases with different partial pressured, the final pressure is the result of adding both partial pressures. };
...
%In Figure \ref{Fig:{\chapterlabel}\thefigurenewcounter}, we have that after combining two gases with different partial pressures the resulting pressure is the addition of both partial pressured.
...
\stepcounter{figurenewcounter}   \refstepcounter{figure}  \label{Fig:{\chapterlabel}\thefigurenewcounter} \hspace{0cm}\begin{minipage}[b]{1.0\linewidth}
\begin{tikzpicture} \node (a) at (0,0) {\includegraphics[width=6cm, height=6cm]{../Ch-Gas/figure8}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]a.south east) {\textsuperscript{\textcopyright} Pst-Labo} ;
...
\draw [->,red] node[font=\small,scale=0.7, xshift=-4.5cm, yshift=.8cm] {\ce{2KClO3_{(s)}}}   (-2.5,0.5) to [out=0,in=360] (-2.5,1.2) node[font=\small,scale=0.7, xshift=-1.5cm, yshift=.0cm] {\ce{2KCl_{(s)} + 3O2_{(g)}}} ; 
	  \node[text width=11cm, fontscale=.2,shift={(6em,-15em)}] at (-1em,5em) { \begin{bf}\color{black}\bfseries\large Figure \ref{Fig:{\chapterlabel}\thefigurenewcounter} \end{bf} Apparatus for measuring the amount of gas produced by a reaction over water. };
\end{tikzpicture}
\end{minipage}


\begin{center}
\stepcounter{tablenewcounter}\refstepcounter{table}\label{tab:{\chapterlabel}\thetablenewcounter}
...
%\begin{marginfigure}[0cm]%%%%%%%MARGIN FIGURE
%\includegraphics{../Ch-Gas/figure3}
...
\end{example}%%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX
 ...
 \stepcounter{figurenewcounter}   \refstepcounter{figure}  \label{Fig:{\chapterlabel}\thefigurenewcounter} \hspace{0cm}\begin{minipage}[b]{1.7\linewidth}
...
As shown in Figure \ref{Fig:{\chapterlabel}\thefigurenewcounter} , the higher temperature the larger the root square velocity, with a wider distribution of velocities. At the same time, the larger the molar mass of the gas, the smaller the root square velocity with a thiner distribution of velocities.
