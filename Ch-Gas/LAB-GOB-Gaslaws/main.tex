...
\renewcommand\ChapterNameLabel{Ch-Gas}\renewcommand\labname{Gaslaws}\renewcommand\chapterpathtocontent{../../}\renewcommand\chapterpath{../LAB-GOB-\labname/}\subfile{./\labname.tex}
