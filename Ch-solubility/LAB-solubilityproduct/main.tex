...
\begin{document} 
    \newcommand\labname{LAB-solubilityproduct}\newcommand\texbooklabel{Ch-solubility}\newcommand\pathtofiles{..}
 \section{A Solubility Product Constant: Solubility product of an iodate salt}\subfile{./\labname.tex }
\end{document}
