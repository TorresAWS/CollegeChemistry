...
\begin{example} %%%%%%%%%%%%%%%%%%%%%%%% EXAMPLE BOX
A mixture is prepared by adding 100mL of 0.01M-\ce{CaNO3} with 50mL of 0.02M-\ce{NaF}. Calculate the number of moles of \ce{CaF2} that precipitate--\ce{CaF2} is insoluble--and the concentration of the leftover ion in solution.
\\
\textlcsc{ \textcolor{dgreen}{\Large \textbf{Solution}} }\\
...
\faDiamond\ \textlcsc{ \textcolor{dgreen}{\Large \textbf{Study Check}} }\\
A mixture is prepared by adding 50mL of 0.03M-\ce{GaCl3} with 75mL of 0.05M-\ce{NaOH}. Calculate the number of moles of \ce{Ga(OH)3} that precipitate and the concentration of the leftover ion in solution.
\\
